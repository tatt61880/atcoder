...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_ax(int64_t k_eg /*n*/);
static void k_bb(type_(Array_<char16_t>) k_el /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bc(T_ k_em /*me_*/, type_(Array_<int64_t>) k_en /*type*/);
template<typename T_>static T_ k_co(T_ k_eo /*me_*/, type_(Array_<int64_t>) k_ep /*type*/, T_ k_eq /*n*/);
template<typename T_>static T_ k_cp(T_ k_er /*me_*/, type_(Array_<int64_t>) k_es /*type*/, int64_t k_et /*n*/);
template<typename T_>static T_ k_db(T_ k_ew /*me_*/, type_(Array_<int64_t>) k_ex /*type*/, int64_t k_ey /*n*/);
static type_(Array_<char16_t>) k_ea();
static int64_t k_ed(type_(Array_<char16_t>) k_fv /*me_*/, bool* k_fw /*success*/);
...
(k_ap) = ((k_an)());
(k_aq) = (0LL);
for(k_au = (1LL), k_av = (k_am); k_au <= k_av; k_au += (1LL)){
(k_aw) = ((k_ax)((k_au)));
