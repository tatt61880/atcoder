...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_bc(int64_t k_ej /*me_*/);
static void k_bf(type_(Array_<char16_t>) k_ek /*str*/);
template<typename T_>static T_ k_cr(T_ k_el /*me_*/, type_(Array_<int64_t>) k_em /*type*/, T_ k_en /*n*/);
template<typename T_>static T_ k_cs(T_ k_eo /*me_*/, type_(Array_<int64_t>) k_ep /*type*/, int64_t k_eq /*n*/);
template<typename T_>static T_ k_de(T_ k_et /*me_*/, type_(Array_<int64_t>) k_eu /*type*/, int64_t k_ev /*n*/);
static type_(Array_<char16_t>) k_ed();
static int64_t k_eg(type_(Array_<char16_t>) k_fs /*me_*/, bool* k_ft /*success*/);
...
(k_aq) = (0LL);
(k_ar) = (true);
for(k_av = (1LL), k_aw = (k_am); k_av <= k_aw; k_av += (1LL)){
(k_ax) = ((k_an)());
(k_ay) = ((k_an)());
(k_az) = ((k_an)());
(k_ba) = ((k_ax) - (k_ao));
(k_bb) = (((k_bc)(((k_ay) - (k_ap)))) + ((k_bc)(((k_az) - (k_aq)))));
if(((k_bb) <= (k_ba)) && ((((k_ba) - (k_bb)) % (2LL)) == (0LL))){
(k_ao) = (k_ax);
(k_ap) = (k_ay);
(k_aq) = (k_az);
continue;
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_ek->B),stdout);
#else
std::u16string s_=k_ek->B;
