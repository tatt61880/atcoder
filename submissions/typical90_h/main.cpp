...
static void k_bj(type_(Array_<char16_t>) k_fi /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bk(T_ k_fj /*me_*/, type_(Array_<int64_t>) k_fk /*type*/);
template<typename T_>static T_ k_cw(T_ k_fl /*me_*/, type_(Array_<int64_t>) k_fm /*type*/, T_ k_fn /*n*/);
template<typename T_>static T_ k_cx(T_ k_fo /*me_*/, type_(Array_<int64_t>) k_fp /*type*/, int64_t k_fq /*n*/);
template<typename T_>static T_ k_dj(T_ k_ft /*me_*/, type_(Array_<int64_t>) k_fu /*type*/, int64_t k_fv /*n*/);
static type_(Array_<char16_t>) k_ei();
static int64_t k_el(type_(Array_<char16_t>) k_gr /*me_*/, bool* k_gs /*success*/);
static char16_t k_eu();
template<typename T_>static T_ k_fh(T_ k_gt /*me_*/, type_(Array_<int64_t>) k_gu /*type*/, int64_t k_gv /*start*/, int64_t k_gw /*len*/);
static char16_t k_ge();
...
type_(Array_<char16_t>) k_aq; // atcoder
...
(k_am) = ((k_an)());
(k_ao) = ((k_ap)());
(k_aq) = (newArrayBin_<char16_t>(7,"\x61\x00\x74\x00\x63\x00\x6F\x00\x64\x00\x65\x00\x72\x00"));
(k_ar) = (newArrays_<type_(Array_<int64_t>)>((((k_aq)->Len()) + (1LL))));
((k_ar)->At(0LL)) = (1LL);
for(k_av = (0LL), k_aw = ((k_am) - (1LL)); k_av <= k_aw; k_av += (1LL)){
for(k_ba = (0LL), k_bb = (((k_aq)->Len()) - (1LL)); k_ba <= k_bb; k_ba += (1LL)){
if(((k_ao)->At(k_av)) == ((k_aq)->At(k_ba))){
(k_bf) = ((k_ba) + (1LL));
((k_ar)->At(k_bf)) = (((k_ar)->At(k_bf)) + ((k_ar)->At(k_ba)));
(k_bh) = ((k_ba) + (1LL));
((k_ar)->At(k_bh)) = (((k_ar)->At(k_bh)) % ((powI_((10LL), (9LL))) + (7LL)));
}
}
}
(k_bi) = ((k_ar)->At((k_aq)->Len()));
(k_bj)((((newArrayBin_<char16_t>(0,""))->Cat(k_bk<int64_t>((k_bi), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_fi->B),stdout);
#else
std::u16string s_=k_fi->B;
...
// inputStr
static type_(Array_<char16_t>) k_ei(){
type_(Array_<char16_t>) k_fy; // buf
int64_t k_fz; // ptr
char16_t k_gd; // c
(k_fy) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fz) = (0LL);
while(true){
(k_gd) = ((k_ge)());
if((k_gd) == (u'\uFFFF')){
...
if((k_fz) == ((k_fy)->Len())){
(k_fy) = ((k_fy)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fy)->Len()))));
}
((k_fy)->At(k_fz)) = (k_gd);
(k_fz) = ((k_fz) + (1LL));
}
return k_fh<type_(Array_<char16_t>)>((k_fy), (nullptr), (0LL), (k_fz));
}
// _toInt
static int64_t k_el(type_(Array_<char16_t>) k_gr /*me_*/, bool* k_gs /*success*/){
std::u16string u_=k_gr->B;
...
while(true){
(k_ha) = ((k_eu)());
for(k_he = (0LL), k_hf = (((k_al)->Len()) - (1LL)); k_he <= k_hf; k_he += (1LL)){
if(((k_ha) == ((k_al)->At(k_he))) || (((k_ha) == (u'\u000D')) && (((k_al)->At(k_he)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_ha) == (u'\u000D')){
