...
using k_cp=uint64_t(*)(type_(k_n));
static uint64_t k_y(type_(k_n) k_cs /*me*/);
using k_cu=uint32_t(*)(type_(k_n));
static double k_z(type_(k_n) k_cx /*me*/, double k_cy /*min*/, double k_cz /*max*/);
...
static int64_t k_ak();
static int64_t k_an();
static double k_bh(int64_t k_en /*l1*/, int64_t k_eo /*r1*/, int64_t k_ep /*l2*/, int64_t k_eq /*r2*/);
static void k_bi(type_(Array_<char16_t>) k_fe /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bj(T_ k_ff /*me_*/, type_(Array_<int64_t>) k_fg /*type*/);
template<typename T_>static T_ k_cv(T_ k_fh /*me_*/, type_(Array_<int64_t>) k_fi /*type*/, T_ k_fj /*n*/);
template<typename T_>static T_ k_cw(T_ k_fk /*me_*/, type_(Array_<int64_t>) k_fl /*type*/, int64_t k_fm /*n*/);
template<typename T_>static T_ k_di(T_ k_fp /*me_*/, type_(Array_<int64_t>) k_fq /*type*/, int64_t k_fr /*n*/);
static type_(Array_<char16_t>) k_eh();
static int64_t k_ek(type_(Array_<char16_t>) k_go /*me_*/, bool* k_gp /*success*/);
template<typename T_,typename R_>static R_ k_ey(T_ k_gq /*me_*/, type_(Array_<int64_t>) k_gr /*type*/);
template<typename T_,typename R_>static R_ k_fc(T_ k_gs /*me_*/, type_(Array_<int64_t>) k_gt /*type*/);
static char16_t k_ga();
template<typename T_>static T_ k_gn(T_ k_hi /*me_*/, type_(Array_<int64_t>) k_hj /*type*/, int64_t k_hk /*start*/, int64_t k_hl /*len*/);
static char16_t k_gy();
...
static void k_g(){
int64_t k_am; // n
type_(Array_<int64_t>) k_ao; // l
type_(Array_<int64_t>) k_ap; // r
int64_t k_at;
double k_av; // ans
int64_t k_az;
int64_t k_be;
...
(k_av) = (0.0);
for(k_az = (0LL), k_ba = ((k_am) - (2LL)); k_az <= k_ba; k_az += (1LL)){
for(k_be = ((k_az) + (1LL)), k_bf = ((k_am) - (1LL)); k_be <= k_bf; k_be += (1LL)){
(k_av) = ((k_av) + ((k_bh)(((k_ao)->At(k_az)), ((k_ap)->At(k_az)), ((k_ao)->At(k_be)), ((k_ap)->At(k_be)))));
}
}
(k_bi)((((newArrayBin_<char16_t>(0,""))->Cat(k_bj<double>((k_av), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
uint64_t k_cl; // m
uint64_t k_cm; // r
(k_ck) = (static_cast<uint64_t>(((k_ch) - (k_cg)) + (1LL)));
(k_cl) = ((0x0000000000000000ULL) - (((0x0000000000000000ULL) - (k_ck)) % (k_ck)));
(k_cm) = (0x0000000000000000ULL);
if((k_cl) == (0x0000000000000000ULL)){
(k_cm) = ((reinterpret_cast<k_cp>(classTable_[(k_cf)->Y + 9]))((k_cf)));
}
else{
do{
(k_cm) = ((reinterpret_cast<k_cp>(classTable_[(k_cf)->Y + 9]))((k_cf)));
...
return (static_cast<int64_t>((k_cm) % (k_ck))) + (k_cg);
}
// rndBit64
static uint64_t k_y(type_(k_n) k_cs /*me*/){
uint32_t k_ct; // t
(k_ct) = ((reinterpret_cast<k_cu>(classTable_[(k_cs)->Y + 12]))((k_cs)));
return k_cv<uint64_t>((k_cw<uint64_t>((static_cast<uint64_t>(k_ct)), (nullptr), (32LL))), (nullptr), (static_cast<uint64_t>((reinterpret_cast<k_cu>(classTable_[(k_cs)->Y + 12]))((k_cs)))));
}
// rndFloat
static double k_z(type_(k_n) k_cx /*me*/, double k_cy /*min*/, double k_cz /*max*/){
return (((static_cast<double>((reinterpret_cast<k_cp>(classTable_[(k_cx)->Y + 9]))((k_cx)))) / (1.844674407370955e+19)) * ((k_cz) - (k_cy))) + (k_cy);
}
// setSeed
static void k_aa(type_(k_n) k_dc /*me*/, uint32_t k_dd /*seed*/){
...
static uint32_t k_ab(type_(k_n) k_dj /*me*/){
uint32_t k_dk; // t
(k_dk) = (k_ai<uint32_t>(((k_dj)->k_de), (nullptr), (k_cw<uint32_t>(((k_dj)->k_de), (nullptr), (11LL)))));
((k_dj)->k_de) = ((k_dj)->k_df);
((k_dj)->k_df) = ((k_dj)->k_dg);
((k_dj)->k_dg) = ((k_dj)->k_dh);
...
(k_ev) = ((((k_eo) - (k_en)) + (1LL)) * (((k_eq) - (k_ep)) + (1LL)));
(k_ew) = (0LL);
(k_ew) = ((k_ew) + ((((k_eo) - (k_en)) + (1LL)) * (k_ey<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)(((k_en) - (k_ep)), (0LL))), (nullptr)))));
(k_ew) = ((k_ew) + ((k_ey<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)(((k_eo) - (k_eq)), (0LL))), (nullptr))) * (((k_eq) - (k_ep)) + (1LL))));
(k_ew) = ((k_ew) - ((k_ey<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)(((k_eo) - (k_eq)), (0LL))), (nullptr))) * (k_ey<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)(((k_en) - (k_ep)), (0LL))), (nullptr)))));
(k_fb) = (((k_fc<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((k_eo), (k_eq))), (nullptr))) - (k_ey<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((k_en), (k_ep))), (nullptr)))) + (1LL));
(k_ew) = ((k_ew) + ((((k_fb) * (k_fb)) - (k_fb)) / (2LL)));
return (static_cast<double>(k_ew)) / (static_cast<double>(k_ev));
}
// print
static void k_bi(type_(Array_<char16_t>) k_fe /*str*/){
if(k_fe==nullptr){
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_fe->B),stdout);
#else
std::u16string s_=k_fe->B;
...
// inputStr
static type_(Array_<char16_t>) k_eh(){
type_(Array_<char16_t>) k_fu; // buf
int64_t k_fv; // ptr
char16_t k_fz; // c
(k_fu) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fv) = (0LL);
while(true){
(k_fz) = ((k_ga)());
if((k_fz) == (u'\uFFFF')){
...
if((k_fv) == ((k_fu)->Len())){
(k_fu) = ((k_fu)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fu)->Len()))));
}
((k_fu)->At(k_fv)) = (k_fz);
(k_fv) = ((k_fv) + (1LL));
}
return k_gn<type_(Array_<char16_t>)>((k_fu), (nullptr), (0LL), (k_fv));
}
// _toInt
static int64_t k_ek(type_(Array_<char16_t>) k_go /*me_*/, bool* k_gp /*success*/){
std::u16string u_=k_go->B;
...
if(cmp_(r_,k_gq->B[i_])<0)r_=k_gq->B[i_];
}
return r_;
}
// _min
...
auto r_=k_gs->B[0];
for(int64_t i_=1;i_<l_;i_++){
if(cmp_(r_,k_gs->B[i_])>0)r_=k_gs->B[i_];
}
return r_;
}
...
while(true){
(k_gx) = ((k_gy)());
for(k_hc = (0LL), k_hd = (((k_al)->Len()) - (1LL)); k_hc <= k_hd; k_hc += (1LL)){
if(((k_gx) == ((k_al)->At(k_hc))) || (((k_gx) == (u'\u000D')) && (((k_al)->At(k_hc)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_gx) == (u'\u000D')){
