...
static double k_an();
static int64_t k_as();
static double k_ay(double k_ep /*x*/);
static double k_ba(double k_eq /*x*/);
static double k_bc(double k_er /*rad*/);
static double k_bd(double k_es /*x*/);
static void k_be(type_(Array_<char16_t>) k_et /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bf(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/);
template<typename T_>static T_ k_cr(T_ k_ew /*me_*/, type_(Array_<int64_t>) k_ex /*type*/, T_ k_ey /*n*/);
template<typename T_>static T_ k_cs(T_ k_ez /*me_*/, type_(Array_<int64_t>) k_fa /*type*/, int64_t k_fb /*n*/);
template<typename T_>static T_ k_de(T_ k_fe /*me_*/, type_(Array_<int64_t>) k_ff /*type*/, int64_t k_fg /*n*/);
static type_(Array_<char16_t>) k_ed();
static double k_eg(type_(Array_<char16_t>) k_gd /*me_*/, bool* k_ge /*success*/);
static int64_t k_em(type_(Array_<char16_t>) k_gf /*me_*/, bool* k_gg /*success*/);
static char16_t k_fp();
template<typename T_>static T_ k_gc(T_ k_gv /*me_*/, type_(Array_<int64_t>) k_gw /*type*/, int64_t k_gx /*start*/, int64_t k_gy /*len*/);
...
(k_aq) = ((k_an)());
(k_ar) = ((k_as)());
for(k_au = (1LL), k_av = (k_ar); k_au <= k_av; k_au += (1LL)){
(k_aw) = ((k_an)());
(k_ax) = (((-(k_ao)) / (2.0)) * ((k_ay)((((6.283185307179586) * (k_aw)) / (k_am)))));
(k_az) = (((k_ao) / (2.0)) * ((1.0) - ((k_ba)((((6.283185307179586) * (k_aw)) / (k_am))))));
(k_bb) = ((k_bc)(((k_bd)(((k_az) / (pow(((pow((k_ap), (2.0))) + (pow(((k_ax) - (k_aq)), (2.0)))), (0.5))))))));
(k_be)((((newArrayBin_<char16_t>(0,""))->Cat(k_bf<double>((k_bb), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
}
// _finVars
static void k_i(){
...
// toDegree
static double k_bc(double k_er /*rad*/){
return ((k_er) * (180.0)) / (3.141592653589793);
}
// atan
static double k_bd(double k_es /*x*/){
return std::atan(k_es);
}
// print
static void k_be(type_(Array_<char16_t>) k_et /*str*/){
if(k_et==nullptr){
...
if((k_fk) == ((k_fj)->Len())){
(k_fj) = ((k_fj)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fj)->Len()))));
}
((k_fj)->At(k_fk)) = (k_fo);
(k_fk) = ((k_fk) + (1LL));
}
