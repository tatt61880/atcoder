...
func main()
	...
	var ans: bool :: a * b % 2 = 0
	do cui@print((ans ?("Even", "Odd")) ~ "\n")
end func
#endif
...
(k_am) = ((k_an)());
(k_ao) = ((k_an)());
(k_ap) = ((((k_am) * (k_ao)) % (2LL)) == (0LL));
(k_aq)((((k_ap) ? (newArrayBin_<char16_t>(4,"\x45\x00\x76\x00\x65\x00\x6E\x00")) : (newArrayBin_<char16_t>(3,"\x4F\x00\x64\x00\x64\x00")))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
