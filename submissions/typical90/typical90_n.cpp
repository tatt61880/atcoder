...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static void k_ba(T_ k_eo /*me_*/, type_(Array_<int64_t>) k_ep /*type*/);
static int64_t k_bi(int64_t k_eq /*me_*/);
static void k_bj(type_(Array_<char16_t>) k_er /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bk(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/);
template<typename T_>static T_ k_cw(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/, T_ k_ew /*n*/);
template<typename T_>static T_ k_cx(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
template<typename T_>static T_ k_dj(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/);
static type_(Array_<char16_t>) k_ei();
static int64_t k_el(type_(Array_<char16_t>) k_gb /*me_*/, bool* k_gc /*success*/);
...
for(k_ay = (0LL), k_az = ((k_am) - (1LL)); k_ay <= k_az; k_ay += (1LL)){
((k_au)->At(k_ay)) = ((k_an)());
}
k_ba<type_(Array_<int64_t>)>((k_ao), (nullptr));
k_ba<type_(Array_<int64_t>)>((k_au), (nullptr));
(k_bb) = (0LL);
for(k_bf = (0LL), k_bg = ((k_am) - (1LL)); k_bf <= k_bg; k_bf += (1LL)){
(k_bb) = ((k_bb) + ((k_bi)((((k_ao)->At(k_bf)) - ((k_au)->At(k_bf))))));
}
(k_bj)((((newArrayBin_<char16_t>(0,""))->Cat(k_bk<int64_t>((k_bb), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
