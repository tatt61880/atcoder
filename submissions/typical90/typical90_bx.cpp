...
static int64_t k_ak();
static int64_t k_an();
static void k_bq(type_(Array_<char16_t>) k_eu /*str*/);
template<typename T_>static T_ k_dc(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, T_ k_ex /*n*/);
template<typename T_>static T_ k_dd(T_ k_ey /*me_*/, type_(Array_<int64_t>) k_ez /*type*/, int64_t k_fa /*n*/);
template<typename T_>static T_ k_dp(T_ k_fd /*me_*/, type_(Array_<int64_t>) k_fe /*type*/, int64_t k_ff /*n*/);
static type_(Array_<char16_t>) k_eo();
static int64_t k_er(type_(Array_<char16_t>) k_gc /*me_*/, bool* k_gd /*success*/);
static char16_t k_fo();
template<typename T_>static T_ k_gb(T_ k_gs /*me_*/, type_(Array_<int64_t>) k_gt /*type*/, int64_t k_gu /*start*/, int64_t k_gv /*len*/);
static char16_t k_gi();
...
(k_bd) = (0LL);
while((k_bb) != ((2LL) * (k_am))){
if(((k_bd) < (k_ap)) && ((k_bc) != ((2LL) * (k_am)))){
(k_bd) = ((k_bd) + ((k_ao)->At(k_bc)));
if((k_bd) == (k_ap)){
(k_ax) = (true);
break;
}
...
(k_bd) = ((k_bd) - ((k_ao)->At(k_bb)));
(k_bb) = ((k_bb) + (1LL));
}
}
}
(k_bq)((((k_ax) ? (newArrayBin_<char16_t>(3,"\x59\x00\x65\x00\x73\x00")) : (newArrayBin_<char16_t>(2,"\x4E\x00\x6F\x00")))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
while(true){
(k_gh) = ((k_gi)());
for(k_gm = (0LL), k_gn = (((k_al)->Len()) - (1LL)); k_gm <= k_gn; k_gm += (1LL)){
if(((k_gh) == ((k_al)->At(k_gm))) || (((k_gh) == (u'\u000D')) && (((k_al)->At(k_gm)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_gh) == (u'\u000D')){
