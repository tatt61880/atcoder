...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static void k_av(T_ k_ek /*me_*/, type_(Array_<int64_t>) k_el /*type*/);
static int64_t k_bd(int64_t k_em /*me_*/);
static void k_bf(type_(Array_<char16_t>) k_en /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bg(T_ k_eo /*me_*/, type_(Array_<int64_t>) k_ep /*type*/);
template<typename T_>static T_ k_cs(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/, T_ k_es /*n*/);
template<typename T_>static T_ k_ct(T_ k_et /*me_*/, type_(Array_<int64_t>) k_eu /*type*/, int64_t k_ev /*n*/);
template<typename T_>static T_ k_df(T_ k_ey /*me_*/, type_(Array_<int64_t>) k_ez /*type*/, int64_t k_fa /*n*/);
static type_(Array_<char16_t>) k_ee();
static int64_t k_eh(type_(Array_<char16_t>) k_fx /*me_*/, bool* k_fy /*success*/);
...
static void k_g(){
int64_t k_am; // n
type_(Array_<int64_t>) k_ao; // x
type_(Array_<int64_t>) k_ap; // y
int64_t k_at;
int64_t k_aw; // ans
int64_t k_ba;
int64_t k_au;
...
k_av<type_(Array_<int64_t>)>((k_ap), (nullptr));
(k_aw) = (0LL);
for(k_ba = (0LL), k_bb = ((k_am) - (1LL)); k_ba <= k_bb; k_ba += (1LL)){
(k_aw) = ((k_aw) + ((k_bd)((((k_ao)->At(k_ba)) - ((k_ao)->At((k_am) / (2LL)))))));
(k_aw) = ((k_aw) + ((k_bd)((((k_ap)->At(k_ba)) - ((k_ap)->At((k_am) / (2LL)))))));
}
(k_bf)((((newArrayBin_<char16_t>(0,""))->Cat(k_bg<int64_t>((k_aw), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
static uint32_t k_ab(type_(k_n) k_dg /*me*/){
uint32_t k_dh; // t
(k_dh) = (k_ai<uint32_t>(((k_dg)->k_db), (nullptr), (k_ct<uint32_t>(((k_dg)->k_db), (nullptr), (11LL)))));
((k_dg)->k_db) = ((k_dg)->k_dc);
((k_dg)->k_dc) = ((k_dg)->k_dd);
((k_dg)->k_dd) = ((k_dg)->k_de);
