...
static void k_j();
static void k_k();
static void k_m(int64_t k_bh /*excpt*/);
static void k_q(type_(k_p) k_bk /*me*/);
static void k_r(k_p* k_bl);
static int64_t k_s(type_(k_p) k_bm /*me*/, type_(k_p) k_bn /*t*/);
static type_(k_p) k_t(type_(k_p) k_bo /*me*/);
static type_(Array_<uint8_t>) k_u(type_(k_p) k_br /*me*/);
static type_(k_p) k_v(type_(k_p) k_bt /*me*/, type_(Array_<uint8_t>) k_bu /*bin*/, int64_t* k_bv /*idx*/);
static type_(Array_<char16_t>) k_w(type_(k_p) k_by /*me*/);
static void k_x(type_(k_o) k_bz /*me*/);
using k_cb=void(*)(type_(k_p));
static int64_t k_y(type_(k_o) k_cc /*me*/, int64_t k_cd /*min*/, int64_t k_ce /*max*/);
using k_cm=uint64_t(*)(type_(k_o));
static uint64_t k_z(type_(k_o) k_cp /*me*/);
using k_cr=uint32_t(*)(type_(k_o));
static double k_aa(type_(k_o) k_cu /*me*/, double k_cv /*min*/, double k_cw /*max*/);
static void k_ab(type_(k_o) k_cz /*me*/, uint32_t k_da /*seed*/);
static uint32_t k_ac(type_(k_o) k_dg /*me*/);
static void k_ad(k_o* k_di);
static type_(k_o) k_ae(type_(k_o) k_dj);
static type_(Array_<uint8_t>) k_af(type_(k_o) k_dm);
static type_(k_o) k_ag(type_(k_o) k_ds, type_(Array_<uint8_t>) k_dt, int64_t* k_du);
static type_(k_o) k_ah(type_(k_o) k_dx /*me2*/, uint32_t k_dy /*seed*/);
using k_dz=void(*)(type_(k_o), uint32_t);
template<typename T_>static T_ k_aj(T_ k_ea /*me_*/, type_(Array_<int64_t>) k_eb /*type*/, T_ k_ec /*n*/);
static int64_t k_ak();
static int64_t k_al();
static int64_t k_aq();
static int64_t k_be(int64_t k_ek /*value*/, int64_t k_el /*exponent*/, int64_t k_em /*modulus*/);
static void k_bf(type_(Array_<char16_t>) k_eq /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bg(T_ k_er /*me_*/, type_(Array_<int64_t>) k_es /*type*/);
template<typename T_>static T_ k_cs(T_ k_et /*me_*/, type_(Array_<int64_t>) k_eu /*type*/, T_ k_ev /*n*/);
template<typename T_>static T_ k_ct(T_ k_ew /*me_*/, type_(Array_<int64_t>) k_ex /*type*/, int64_t k_ey /*n*/);
template<typename T_>static T_ k_df(T_ k_fb /*me_*/, type_(Array_<int64_t>) k_fc /*type*/, int64_t k_fd /*n*/);
static type_(Array_<char16_t>) k_ee();
static int64_t k_eh(type_(Array_<char16_t>) k_ga /*me_*/, bool* k_gb /*success*/);
static uint64_t k_ep(uint64_t k_gc /*value*/, uint64_t k_gd /*exponent*/, uint64_t k_ge /*modulus*/);
static char16_t k_fm();
template<typename T_>static T_ k_fz(T_ k_gz /*me_*/, type_(Array_<int64_t>) k_ha /*type*/, int64_t k_hb /*start*/, int64_t k_hc /*len*/);
template<typename T_>static T_ k_gi(T_ k_hd /*me_*/, type_(Array_<int64_t>) k_he /*type*/, T_ k_hf /*n*/);
static uint64_t k_gk(uint64_t k_hg /*a*/, uint64_t k_hh /*b*/, uint64_t k_hi /*modulus*/);
...
k_o::k_o(): k_p(), k_db(), k_dc(), k_dd(), k_de(){ Y = 8; }
k_o::~k_o(){
k_ad(this);
}
// k_main_
...
(k_as) = (((k_ar) * ((k_ar) - (1LL))) % (1000000007LL));
}
break;
default:
if((k_ar) < (3LL)){
...
(k_as) = (((((k_ar) * ((k_ar) - (1LL))) % (1000000007LL)) * (((k_be)(((k_ar) - (2LL)), ((k_ap) - (2LL)), (1000000007LL))) % (1000000007LL))) % (1000000007LL));
}
break;
}
(k_bf)((((newArrayBin_<char16_t>(0,""))->Cat(k_bg<int64_t>((k_as), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_j(){
(k_ao) = (nullptr);
...
return as_<k_p>(classTable_, (k_bp), 0);
}
// _toBin
static type_(Array_<uint8_t>) k_u(type_(k_p) k_br /*me*/){
...
type_(k_p) k_bw;
type_(k_p) k_bx;
(k_bw) = (k_bx = new_(k_p)(), k_q(k_bx), k_bx);
return k_bw;
}
// toStr
static type_(Array_<char16_t>) k_w(type_(k_p) k_by /*me*/){
...
return (static_cast<int64_t>((k_cj) % (k_ch))) + (k_cd);
}
// rndBit64
static uint64_t k_z(type_(k_o) k_cp /*me*/){
uint32_t k_cq; // t
...
static uint32_t k_ac(type_(k_o) k_dg /*me*/){
uint32_t k_dh; // t
(k_dh) = (k_aj<uint32_t>(((k_dg)->k_db), (nullptr), (k_ct<uint32_t>(((k_dg)->k_db), (nullptr), (11LL)))));
((k_dg)->k_db) = ((k_dg)->k_dc);
((k_dg)->k_dc) = ((k_dg)->k_dd);
((k_dg)->k_dd) = ((k_dg)->k_de);
((k_dg)->k_de) = (k_aj<uint32_t>((k_aj<uint32_t>(((k_dg)->k_de), (nullptr), (k_df<uint32_t>(((k_dg)->k_de), (nullptr), (19LL))))), (nullptr), (k_aj<uint32_t>((k_dh), (nullptr), (k_df<uint32_t>((k_dh), (nullptr), (8LL)))))));
return (k_dg)->k_de;
}
// _dtor
static void k_ad(k_o* k_di){
...
((k_dk)->k_dd) = ((k_dj)->k_dd);
((k_dk)->k_de) = ((k_dj)->k_de);
return as_<k_o>(classTable_, (k_dk), 8);
}
// _toBin
static type_(Array_<uint8_t>) k_af(type_(k_o) k_dm){
...
type_(k_o) k_dv;
type_(k_o) k_dw;
(k_dv) = (k_dw = new_(k_o)(), k_x(k_dw), k_dw);
...
// modPow
static int64_t k_be(int64_t k_ek /*value*/, int64_t k_el /*exponent*/, int64_t k_em /*modulus*/){
if((((k_ek) < (0LL)) || ((k_el) < (0LL))) || ((k_em) < (0LL))){
throw 3910598662LL;
}
return static_cast<int64_t>((k_ep)((static_cast<uint64_t>(k_ek)), (static_cast<uint64_t>(k_el)), (static_cast<uint64_t>(k_em))));
}
// print
static void k_bf(type_(Array_<char16_t>) k_eq /*str*/){
if(k_eq==nullptr){
...
static uint64_t k_ep(uint64_t k_gc /*value*/, uint64_t k_gd /*exponent*/, uint64_t k_ge /*modulus*/){
uint64_t k_gf; // w
(k_gf) = (0x0000000000000001ULL);
while((k_gd) > (0x0000000000000000ULL)){
if((k_gi<uint64_t>((k_gd), (nullptr), (0x0000000000000001ULL))) != (0x0000000000000000ULL)){
(k_gf) = ((k_gk)((k_gf), (k_gc), (k_ge)));
}
(k_gc) = ((k_gk)((k_gc), (k_gc), (k_ge)));
(k_gd) = (k_df<uint64_t>((k_gd), (nullptr), (1LL)));
}
return k_gf;
}
...
(k_hm) = (0x0000000000000000ULL);
while((k_hg) > (0x0000000000000000ULL)){
if((k_gi<uint64_t>((k_hg), (nullptr), (0x0000000000000001ULL))) != (0x0000000000000000ULL)){
(k_hm) = (((k_hm) + (k_hh)) % (k_hi));
}
(k_hh) = ((k_ct<uint64_t>((k_hh), (nullptr), (1LL))) % (k_hi));
(k_hg) = (k_df<uint64_t>((k_hg), (nullptr), (1LL)));
}
return k_hm;
}
// inputLetter
