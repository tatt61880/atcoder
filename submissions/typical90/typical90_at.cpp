...
static int64_t k_ak();
static int64_t k_an();
static void k_bu(type_(Array_<char16_t>) k_ez /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bv(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/);
template<typename T_>static T_ k_dh(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, T_ k_fe /*n*/);
template<typename T_>static T_ k_di(T_ k_ff /*me_*/, type_(Array_<int64_t>) k_fg /*type*/, int64_t k_fh /*n*/);
template<typename T_>static T_ k_du(T_ k_fk /*me_*/, type_(Array_<int64_t>) k_fl /*type*/, int64_t k_fm /*n*/);
static type_(Array_<char16_t>) k_et();
static int64_t k_ew(type_(Array_<char16_t>) k_gj /*me_*/, bool* k_gk /*success*/);
...
int64_t k_as;
int64_t k_ax;
type_(Array_<type_(Array_<int64_t>)>) k_az; // dp
int64_t k_bd;
int64_t k_bi;
int64_t k_bk; // v
int64_t k_bo;
type_(Array_<int64_t>) k_br;
int64_t k_bs;
int64_t k_bt; // ans
int64_t k_at;
int64_t k_ay;
...
int64_t k_bp;
(k_am) = ((k_an)());
(k_ao) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>((3LL), (k_am)));
for(k_as = (0LL), k_at = (2LL); k_as <= k_at; k_as += (1LL)){
for(k_ax = (0LL), k_ay = ((k_am) - (1LL)); k_ax <= k_ay; k_ax += (1LL)){
(((k_ao)->At(k_as))->At(k_ax)) = ((k_an)());
}
}
(k_az) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>((4LL), (46LL)));
(((k_az)->At(0LL))->At(0LL)) = (1LL);
for(k_bd = (0LL), k_be = (2LL); k_bd <= k_be; k_bd += (1LL)){
for(k_bi = (0LL), k_bj = ((k_am) - (1LL)); k_bi <= k_bj; k_bi += (1LL)){
(k_bk) = (((k_ao)->At(k_bd))->At(k_bi));
for(k_bo = (0LL), k_bp = (45LL); k_bo <= k_bp; k_bo += (1LL)){
(k_br) = ((k_az)->At((k_bd) + (1LL)));
(k_bs) = (((k_bo) + (k_bk)) % (46LL));
((k_br)->At(k_bs)) = (((k_br)->At(k_bs)) + (((k_az)->At(k_bd))->At(k_bo)));
}
}
}
(k_bt) = (((k_az)->At(3LL))->At(0LL));
