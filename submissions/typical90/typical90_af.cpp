...
static int64_t k_ak();
static int64_t k_an();
template<typename T_,typename R_>static R_ k_bz(T_ k_fi /*me_*/, type_(Array_<int64_t>) k_fj /*type*/);
static bool k_ca(type_(Array_<int64_t>) k_fk /*arr*/);
static void k_cd(type_(Array_<char16_t>) k_fz /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_ce(T_ k_ga /*me_*/, type_(Array_<int64_t>) k_gb /*type*/);
template<typename T_>static T_ k_dq(T_ k_gc /*me_*/, type_(Array_<int64_t>) k_gd /*type*/, T_ k_ge /*n*/);
template<typename T_>static T_ k_dr(T_ k_gf /*me_*/, type_(Array_<int64_t>) k_gg /*type*/, int64_t k_gh /*n*/);
template<typename T_>static T_ k_ed(T_ k_gk /*me_*/, type_(Array_<int64_t>) k_gl /*type*/, int64_t k_gm /*n*/);
static type_(Array_<char16_t>) k_fc();
static int64_t k_ff(type_(Array_<char16_t>) k_hj /*me_*/, bool* k_hk /*success*/);
...
static void k_g(){
int64_t k_am; // n
type_(Array_<type_(Array_<int64_t>)>) k_ao; // a
int64_t k_as;
int64_t k_ax;
int64_t k_az; // m
type_(Array_<type_(Array_<bool>)>) k_ba; // xy
int64_t k_bc;
int64_t k_be; // x
int64_t k_bf; // y
type_(Array_<int64_t>) k_bg; // idxs
int64_t k_bk;
int64_t k_bm; // ans
int64_t k_bq; // t
int64_t k_bu;
...
int64_t k_bv;
(k_am) = ((k_an)());
(k_ao) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>((k_am), (k_am)));
for(k_as = (0LL), k_at = ((k_am) - (1LL)); k_as <= k_at; k_as += (1LL)){
for(k_ax = (0LL), k_ay = ((k_am) - (1LL)); k_ax <= k_ay; k_ax += (1LL)){
(((k_ao)->At(k_as))->At(k_ax)) = ((k_an)());
}
}
(k_az) = ((k_an)());
(k_ba) = (newArrays_<type_(Array_<type_(Array_<bool>)>)>((k_am), (k_am)));
for(k_bc = (1LL), k_bd = (k_az); k_bc <= k_bd; k_bc += (1LL)){
(k_be) = (((k_an)()) - (1LL));
(k_bf) = (((k_an)()) - (1LL));
(((k_ba)->At(k_be))->At(k_bf)) = (true);
(((k_ba)->At(k_bf))->At(k_be)) = (true);
}
(k_bg) = (newArrays_<type_(Array_<int64_t>)>((k_am)));
for(k_bk = (0LL), k_bl = ((k_am) - (1LL)); k_bk <= k_bl; k_bk += (1LL)){
((k_bg)->At(k_bk)) = (k_bk);
}
(k_bm) = (9223372036854775807LL);
do{
(k_bq) = (((k_ao)->At((k_bg)->At(0LL)))->At(0LL));
for(k_bu = (1LL), k_bv = ((k_am) - (1LL)); k_bu <= k_bv; k_bu += (1LL)){
if(((k_ba)->At((k_bg)->At(k_bu)))->At((k_bg)->At((k_bu) - (1LL)))){
goto k_bp;
}
(k_bq) = ((k_bq) + (((k_ao)->At((k_bg)->At(k_bu)))->At(k_bu)));
}
(k_bm) = (k_bz<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((k_bm), (k_bq))), (nullptr)));
k_bp:;
}while((k_ca)((k_bg)));
if((k_bm) == (9223372036854775807LL)){
(k_bm) = (-1LL);
}
(k_cd)((((newArrayBin_<char16_t>(0,""))->Cat(k_ce<int64_t>((k_bm), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
if(cmp_(r_,k_fi->B[i_])>0)r_=k_fi->B[i_];
}
return r_;
}
// nextPermutation
...
(k_fl) = ((k_fk)->Len());
(k_fm) = ((k_fl) - (2LL));
while(((k_fm) >= (0LL)) && (((k_fk)->At(k_fm)) >= ((k_fk)->At((k_fm) + (1LL))))){
(k_fm) = ((k_fm) - (1LL));
}
if((k_fm) < (0LL)){
return false;
...
(k_fr) = ((k_fl) - (1LL));
while(((k_fk)->At(k_fm)) >= ((k_fk)->At(k_fr))){
(k_fr) = ((k_fr) - (1LL));
}
(k_fu) = ((k_fk)->At(k_fm));
((k_fk)->At(k_fm)) = ((k_fk)->At(k_fr));
((k_fk)->At(k_fr)) = (k_fu);
(k_fm) = ((k_fm) + (1LL));
(k_fr) = ((k_fl) - (1LL));
while((k_fm) < (k_fr)){
