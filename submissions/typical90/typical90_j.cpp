...
template<typename T_>static type_(Array_<char16_t>) k_bl(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/);
template<typename T_>static T_ k_cx(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, T_ k_eu /*n*/);
template<typename T_>static T_ k_cy(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, int64_t k_ex /*n*/);
template<typename T_>static T_ k_dk(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/, int64_t k_fc /*n*/);
static type_(Array_<char16_t>) k_ej();
static int64_t k_em(type_(Array_<char16_t>) k_fz /*me_*/, bool* k_ga /*success*/);
...
static void k_g(){
int64_t k_am; // n
type_(Array_<int64_t>) k_ao; // cum1
type_(Array_<int64_t>) k_ap; // cum2
int64_t k_at;
int64_t k_av; // c
int64_t k_aw; // p
int64_t k_ba;
...
int64_t k_bh;
(k_am) = ((k_an)());
(k_ao) = (newArrays_<type_(Array_<int64_t>)>(((k_am) + (1LL))));
(k_ap) = (newArrays_<type_(Array_<int64_t>)>(((k_am) + (1LL))));
for(k_at = (0LL), k_au = ((k_am) - (1LL)); k_at <= k_au; k_at += (1LL)){
(k_av) = ((k_an)());
(k_aw) = ((k_an)());
((k_ao)->At((k_at) + (1LL))) = ((k_ao)->At(k_at));
((k_ap)->At((k_at) + (1LL))) = ((k_ap)->At(k_at));
if((k_av) == (1LL)){
(k_ba) = ((k_at) + (1LL));
((k_ao)->At(k_ba)) = (((k_ao)->At(k_ba)) + (k_aw));
}
else{
(k_bd) = ((k_at) + (1LL));
((k_ap)->At(k_bd)) = (((k_ap)->At(k_bd)) + (k_aw));
}
}
(k_be) = ((k_an)());
for(k_bg = (1LL), k_bh = (k_be); k_bg <= k_bh; k_bg += (1LL)){
(k_bi) = (((k_an)()) - (1LL));
(k_bj) = ((k_an)());
(k_bk)((((newArrayBin_<char16_t>(0,""))->Cat(k_bl<int64_t>((((k_ao)->At(k_bj)) - ((k_ao)->At(k_bi))), (nullptr))))->Cat(((newArrayBin_<char16_t>(1,"\x20\x00"))->Cat(k_bl<int64_t>((((k_ap)->At(k_bj)) - ((k_ap)->At(k_bi))), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00")))));
}
}
// _finVars
static void k_i(){
