...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_bf(int64_t k_eq /*i*/);
static void k_bl(type_(Array_<char16_t>) k_er /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bm(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/);
template<typename T_>static T_ k_cy(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/, T_ k_ew /*n*/);
template<typename T_>static T_ k_cz(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
template<typename T_>static T_ k_dl(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/);
static type_(Array_<char16_t>) k_ek();
static int64_t k_en(type_(Array_<char16_t>) k_gb /*me_*/, bool* k_gc /*success*/);
...
for(k_aw = (1LL), k_ax = (k_ao); k_aw <= k_ax; k_aw += (1LL)){
(k_ay) = ((k_an)());
(k_az) = (((k_an)()) - (1LL));
(k_ba) = (((k_an)()) - (1LL));
k_bc = k_ay;
switch(k_bc){
case 1LL:
(k_be) = ((k_ap)->At((k_bf)((k_az))));
((k_ap)->At((k_bf)((k_az)))) = ((k_ap)->At((k_bf)((k_ba))));
((k_ap)->At((k_bf)((k_ba)))) = (k_be);
break;
case 2LL:
(k_bi) = ((k_bi) + ((k_am) - (1LL)));
break;
case 3LL:
(k_bk) = ((k_ap)->At((k_bf)((k_az))));
...
if((k_fi) == ((k_fh)->Len())){
(k_fh) = ((k_fh)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fh)->Len()))));
}
((k_fh)->At(k_fi)) = (k_fm);
(k_fi) = ((k_fi) + (1LL));
}
