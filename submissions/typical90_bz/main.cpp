...
static int64_t k_ak();
static int64_t k_an();
static void k_bl(type_(Array_<char16_t>) k_eq /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bm(T_ k_er /*me_*/, type_(Array_<int64_t>) k_es /*type*/);
template<typename T_>static T_ k_cy(T_ k_et /*me_*/, type_(Array_<int64_t>) k_eu /*type*/, T_ k_ev /*n*/);
template<typename T_>static T_ k_cz(T_ k_ew /*me_*/, type_(Array_<int64_t>) k_ex /*type*/, int64_t k_ey /*n*/);
template<typename T_>static T_ k_dl(T_ k_fb /*me_*/, type_(Array_<int64_t>) k_fc /*type*/, int64_t k_fd /*n*/);
static type_(Array_<char16_t>) k_ek();
static int64_t k_en(type_(Array_<char16_t>) k_ga /*me_*/, bool* k_gb /*success*/);
static char16_t k_fm();
template<typename T_>static T_ k_fz(T_ k_gq /*me_*/, type_(Array_<int64_t>) k_gr /*type*/, int64_t k_gs /*start*/, int64_t k_gt /*len*/);
static char16_t k_gg();
...
int64_t k_am; // n
int64_t k_ao; // m
type_(Array_<int64_t>) k_ap; // nums
int64_t k_at;
int64_t k_av; // a
int64_t k_aw; // b
int64_t k_bc; // ans
...
for(k_at = (0LL), k_au = ((k_ao) - (1LL)); k_at <= k_au; k_at += (1LL)){
(k_av) = (((k_an)()) - (1LL));
(k_aw) = (((k_an)()) - (1LL));
if((k_av) < (k_aw)){
((k_ap)->At(k_aw)) = (((k_ap)->At(k_aw)) + (1LL));
}
else{
((k_ap)->At(k_av)) = (((k_ap)->At(k_av)) + (1LL));
}
}
(k_bc) = (0LL);
...
(k_bl)((((newArrayBin_<char16_t>(0,""))->Cat(k_bm<int64_t>((k_bc), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_eq->B),stdout);
#else
std::u16string s_=k_eq->B;
...
// inputStr
static type_(Array_<char16_t>) k_ek(){
type_(Array_<char16_t>) k_fg; // buf
int64_t k_fh; // ptr
char16_t k_fl; // c
(k_fg) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fh) = (0LL);
while(true){
(k_fl) = ((k_fm)());
if((k_fl) == (u'\uFFFF')){
...
if((k_fh) == ((k_fg)->Len())){
(k_fg) = ((k_fg)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fg)->Len()))));
}
((k_fg)->At(k_fh)) = (k_fl);
(k_fh) = ((k_fh) + (1LL));
}
return k_fz<type_(Array_<char16_t>)>((k_fg), (nullptr), (0LL), (k_fh));
}
// _toInt
static int64_t k_en(type_(Array_<char16_t>) k_ga /*me_*/, bool* k_gb /*success*/){
std::u16string u_=k_ga->B;
...
while(true){
(k_gf) = ((k_gg)());
for(k_gk = (0LL), k_gl = (((k_al)->Len()) - (1LL)); k_gk <= k_gl; k_gk += (1LL)){
if(((k_gf) == ((k_al)->At(k_gk))) || (((k_gf) == (u'\u000D')) && (((k_al)->At(k_gk)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_gf) == (u'\u000D')){
