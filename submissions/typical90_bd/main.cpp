...
static int64_t k_ak();
static int64_t k_an();
static void k_bv(type_(Array_<char16_t>) k_fp /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_cl(T_ k_fq /*me_*/, type_(Array_<int64_t>) k_fr /*type*/);
template<typename T_>static T_ k_dx(T_ k_fs /*me_*/, type_(Array_<int64_t>) k_ft /*type*/, T_ k_fu /*n*/);
template<typename T_>static T_ k_dy(T_ k_fv /*me_*/, type_(Array_<int64_t>) k_fw /*type*/, int64_t k_fx /*n*/);
template<typename T_>static T_ k_ek(T_ k_ga /*me_*/, type_(Array_<int64_t>) k_gb /*type*/, int64_t k_gc /*n*/);
static type_(Array_<char16_t>) k_fj();
static int64_t k_fm(type_(Array_<char16_t>) k_gz /*me_*/, bool* k_ha /*success*/);
...
int64_t k_am; // n
int64_t k_ao; // s
type_(Array_<type_(Array_<int64_t>)>) k_ap; // ab
int64_t k_at;
int64_t k_ay;
type_(Array_<type_(Array_<bool>)>) k_ba; // dp
int64_t k_be;
int64_t k_bj;
int64_t k_bo;
int64_t k_bq; // prev
type_(Array_<char16_t>) k_bw; // ans
int64_t k_bx; // val
int64_t k_cb;
int64_t k_cg;
int64_t k_ci; // next
...
(k_am) = ((k_an)());
(k_ao) = ((k_an)());
(k_ap) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>(((k_am) + (1LL)), (2LL)));
for(k_at = (1LL), k_au = (k_am); k_at <= k_au; k_at += (1LL)){
for(k_ay = (0LL), k_az = (1LL); k_ay <= k_az; k_ay += (1LL)){
(((k_ap)->At(k_at))->At(k_ay)) = ((k_an)());
}
}
(k_ba) = (newArrays_<type_(Array_<type_(Array_<bool>)>)>(((k_am) + (1LL)), ((k_ao) + (1LL))));
(((k_ba)->At(0LL))->At(0LL)) = (true);
for(k_be = (1LL), k_bf = (k_am); k_be <= k_bf; k_be += (1LL)){
for(k_bj = (k_ao), k_bk = (0LL); k_bj >= k_bk; k_bj += (-1LL)){
for(k_bo = (0LL), k_bp = (1LL); k_bo <= k_bp; k_bo += (1LL)){
(k_bq) = ((k_bj) - (((k_ap)->At(k_be))->At(k_bo)));
if(((k_bq) >= (0LL)) && (((k_ba)->At((k_be) - (1LL)))->At(k_bq))){
(((k_ba)->At(k_be))->At(k_bj)) = (true);
}
}
}
}
if(!(((k_ba)->At(k_am))->At(k_ao))){
(k_bv)((newArrayBin_<char16_t>(11,"\x49\x00\x6D\x00\x70\x00\x6F\x00\x73\x00\x73\x00\x69\x00\x62\x00\x6C\x00\x65\x00\x0A\x00")));
return;
}
(k_bw) = (newArrays_<type_(Array_<char16_t>)>((k_am)));
(k_bx) = (k_ao);
for(k_cb = (k_am), k_cc = (1LL); k_cb >= k_cc; k_cb += (-1LL)){
for(k_cg = (0LL), k_ch = (1LL); k_cg <= k_ch; k_cg += (1LL)){
(k_ci) = ((k_bx) - (((k_ap)->At(k_cb))->At(k_cg)));
if(((k_ci) >= (0LL)) && (((k_ba)->At((k_cb) - (1LL)))->At(k_ci))){
(k_bx) = (k_ci);
((k_bw)->At((k_cb) - (1LL))) = (((k_cg) == (0LL)) ? (u'\u0041') : (u'\u0042'));
break;
}
}
}
(k_bv)((((newArrayBin_<char16_t>(0,""))->Cat(k_cl<type_(Array_<char16_t>)>((k_bw), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
