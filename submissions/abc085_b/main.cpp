...
static int64_t k_ak();
static int64_t k_an();
template<typename T_,typename K_,typename V_>static void k_au(T_ k_eb /*me_*/, type_(Array_<int64_t>) k_ec /*type*/, K_ k_ed /*key*/, V_ k_ee /*item*/);
static void k_aw(type_(Array_<char16_t>) k_ef /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_ax(T_ k_eg /*me_*/, type_(Array_<int64_t>) k_eh /*type*/);
template<typename T_>static T_ k_cj(T_ k_ei /*me_*/, type_(Array_<int64_t>) k_ej /*type*/, T_ k_ek /*n*/);
template<typename T_>static T_ k_ck(T_ k_el /*me_*/, type_(Array_<int64_t>) k_em /*type*/, int64_t k_en /*n*/);
template<typename T_>static T_ k_cw(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/, int64_t k_es /*n*/);
static type_(Array_<char16_t>) k_dv();
static int64_t k_dy(type_(Array_<char16_t>) k_fp /*me_*/, bool* k_fq /*success*/);
static char16_t k_fb();
template<typename T_>static T_ k_fo(T_ k_gf /*me_*/, type_(Array_<int64_t>) k_gg /*type*/, int64_t k_gh /*start*/, int64_t k_gi /*len*/);
...
static void k_g(){
int64_t k_am; // n
type_(Dict_<int64_t, bool>) k_ao; // map
int64_t k_as;
int64_t k_av; // ans
int64_t k_at;
(k_am) = ((k_an)());
(k_ao) = (new_(Dict_<int64_t, bool>)());
for(k_as = (0LL), k_at = ((k_am) - (1LL)); k_as <= k_at; k_as += (1LL)){
k_au<type_(Dict_<int64_t, bool>), int64_t, bool>((k_ao), (nullptr), ((k_an)()), (true));
}
(k_av) = ((k_ao)->Len());
(k_aw)((((newArrayBin_<char16_t>(0,""))->Cat(k_ax<int64_t>((k_av), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_ef->B),stdout);
#else
std::u16string s_=k_ef->B;
...
// inputStr
static type_(Array_<char16_t>) k_dv(){
type_(Array_<char16_t>) k_ev; // buf
int64_t k_ew; // ptr
char16_t k_fa; // c
(k_ev) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_ew) = (0LL);
while(true){
(k_fa) = ((k_fb)());
if((k_fa) == (u'\uFFFF')){
...
if((k_ew) == ((k_ev)->Len())){
(k_ev) = ((k_ev)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_ev)->Len()))));
}
((k_ev)->At(k_ew)) = (k_fa);
(k_ew) = ((k_ew) + (1LL));
}
return k_fo<type_(Array_<char16_t>)>((k_ev), (nullptr), (0LL), (k_ew));
}
// _toInt
static int64_t k_dy(type_(Array_<char16_t>) k_fp /*me_*/, bool* k_fq /*success*/){
std::u16string u_=k_fp->B;
...
while(true){
(k_fu) = ((k_fv)());
for(k_fz = (0LL), k_ga = (((k_al)->Len()) - (1LL)); k_fz <= k_ga; k_fz += (1LL)){
if(((k_fu) == ((k_al)->At(k_fz))) || (((k_fu) == (u'\u000D')) && (((k_al)->At(k_fz)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_fu) == (u'\u000D')){
