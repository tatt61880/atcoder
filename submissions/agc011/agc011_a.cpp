...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static void k_aw(T_ k_en /*me_*/, type_(Array_<int64_t>) k_eo /*type*/);
static void k_bi(type_(Array_<char16_t>) k_ep /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bj(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/);
template<typename T_>static T_ k_cv(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, T_ k_eu /*n*/);
template<typename T_>static T_ k_cw(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, int64_t k_ex /*n*/);
template<typename T_>static T_ k_di(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/, int64_t k_fc /*n*/);
static type_(Array_<char16_t>) k_eh();
static int64_t k_ek(type_(Array_<char16_t>) k_fz /*me_*/, bool* k_ga /*success*/);
...
k_aw<type_(Array_<int64_t>)>((k_aq), (nullptr));
(k_ax) = ((k_aq)->At(0LL));
(k_ay) = (0LL);
(k_az) = (1LL);
for(k_bd = (0LL), k_be = ((k_am) - (1LL)); k_bd <= k_be; k_bd += (1LL)){
if(((k_bd) == ((k_ay) + (k_ao))) || (((k_aq)->At(k_bd)) > ((k_ax) + (k_ap)))){
(k_ay) = (k_bd);
(k_ax) = ((k_aq)->At(k_bd));
(k_az) = ((k_az) + (1LL));
}
}
(k_bi)((((newArrayBin_<char16_t>(0,""))->Cat(k_bj<int64_t>((k_az), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
