...
static int64_t k_ak();
static int64_t k_an();
static void k_bg(type_(Array_<char16_t>) k_el /*str*/);
...
(k_am) = ((k_an)());
(k_ao) = ((k_an)());
(k_ap) = (newArrays_<type_(Array_<int64_t>)>(((k_am) + (1LL))));
((k_ap)->At(0LL)) = (1LL);
for(k_at = (0LL), k_au = ((k_am) - (1LL)); k_at <= k_au; k_at += (1LL)){
(k_aw) = ((k_at) + (1LL));
((k_ap)->At(k_aw)) = (((k_ap)->At(k_aw)) + ((k_ap)->At(k_at)));
(k_ay) = ((k_at) + (1LL));
((k_ap)->At(k_ay)) = (((k_ap)->At(k_ay)) % (1000000007LL));
if(((k_at) + (k_ao)) <= (k_am)){
(k_bc) = ((k_at) + (k_ao));
((k_ap)->At(k_bc)) = (((k_ap)->At(k_bc)) + ((k_ap)->At(k_at)));
(k_be) = ((k_at) + (k_ao));
((k_ap)->At(k_be)) = (((k_ap)->At(k_be)) % (1000000007LL));
}
}
(k_bf) = ((k_ap)->At(k_am));
(k_bg)((((newArrayBin_<char16_t>(0,""))->Cat(k_bh<int64_t>((k_bf), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
