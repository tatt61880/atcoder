...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_bs(int64_t k_fg /*me_*/);
template<typename T_,typename R_>static R_ k_bz(T_ k_fh /*me_*/, type_(Array_<int64_t>) k_fi /*type*/);
static void k_cb(type_(Array_<char16_t>) k_fj /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_cc(T_ k_fk /*me_*/, type_(Array_<int64_t>) k_fl /*type*/);
template<typename T_>static T_ k_do(T_ k_fm /*me_*/, type_(Array_<int64_t>) k_fn /*type*/, T_ k_fo /*n*/);
template<typename T_>static T_ k_dp(T_ k_fp /*me_*/, type_(Array_<int64_t>) k_fq /*type*/, int64_t k_fr /*n*/);
template<typename T_>static T_ k_eb(T_ k_fu /*me_*/, type_(Array_<int64_t>) k_fv /*type*/, int64_t k_fw /*n*/);
static type_(Array_<char16_t>) k_fa();
static int64_t k_fd(type_(Array_<char16_t>) k_gt /*me_*/, bool* k_gu /*success*/);
...
int64_t k_as;
type_(Array_<type_(Array_<int64_t>)>) k_au; // dp
int64_t k_ay;
int64_t k_bd;
int64_t k_bi;
int64_t k_bn;
...
int64_t k_by;
(k_am) = ((k_an)());
(k_ao) = (newArrays_<type_(Array_<int64_t>)>(((2LL) * (k_am))));
for(k_as = (0LL), k_at = (((2LL) * (k_am)) - (1LL)); k_as <= k_at; k_as += (1LL)){
((k_ao)->At(k_as)) = ((k_an)());
}
(k_au) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>(((2LL) * (k_am)), ((2LL) * (k_am))));
for(k_ay = (0LL), k_az = (((2LL) * (k_am)) - (1LL)); k_ay <= k_az; k_ay += (1LL)){
for(k_bd = (0LL), k_be = (((2LL) * (k_am)) - (1LL)); k_bd <= k_be; k_bd += (1LL)){
(((k_au)->At(k_ay))->At(k_bd)) = (powI_((10LL), (9LL)));
}
}
for(k_bi = (2LL), k_bj = ((2LL) * (k_am)); k_bi <= k_bj; k_bi += (2LL)){
for(k_bn = (0LL), k_bo = (((2LL) * (k_am)) - (k_bi)); k_bn <= k_bo; k_bn += (1LL)){
(k_bp) = (((k_bn) + (k_bi)) - (1LL));
if((k_bi) == (2LL)){
(((k_au)->At(k_bn))->At(k_bp)) = ((k_bs)((((k_ao)->At(k_bn)) - ((k_ao)->At(k_bp)))));
}
else{
for(k_bx = ((k_bn) + (1LL)), k_by = ((k_bp) - (2LL)); k_bx <= k_by; k_bx += (1LL)){
(((k_au)->At(k_bn))->At(k_bp)) = (k_bz<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((((k_au)->At(k_bn))->At(k_bp)), ((((k_au)->At(k_bn))->At(k_bx)) + (((k_au)->At((k_bx) + (1LL)))->At(k_bp))))), (nullptr)));
}
(((k_au)->At(k_bn))->At(k_bp)) = (k_bz<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((((k_au)->At(k_bn))->At(k_bp)), ((((k_au)->At((k_bn) + (1LL)))->At((k_bp) - (1LL))) + ((k_bs)((((k_ao)->At(k_bn)) - ((k_ao)->At(k_bp)))))))), (nullptr)));
}
}
}
(k_ca) = (((k_au)->At(0LL))->At(((2LL) * (k_am)) - (1LL)));
(k_cb)((((newArrayBin_<char16_t>(0,""))->Cat(k_cc<int64_t>((k_ca), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
if(cmp_(r_,k_fh->B[i_])>0)r_=k_fh->B[i_];
}
return r_;
}
// print
