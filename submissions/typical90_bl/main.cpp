...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_bd(int64_t k_fa /*me_*/);
static void k_bv(type_(Array_<char16_t>) k_fb /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bw(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/);
template<typename T_>static T_ k_di(T_ k_fe /*me_*/, type_(Array_<int64_t>) k_ff /*type*/, T_ k_fg /*n*/);
template<typename T_>static T_ k_dj(T_ k_fh /*me_*/, type_(Array_<int64_t>) k_fi /*type*/, int64_t k_fj /*n*/);
template<typename T_>static T_ k_dv(T_ k_fm /*me_*/, type_(Array_<int64_t>) k_fn /*type*/, int64_t k_fo /*n*/);
static type_(Array_<char16_t>) k_eu();
static int64_t k_ex(type_(Array_<char16_t>) k_gl /*me_*/, bool* k_gm /*success*/);
static char16_t k_fx();
template<typename T_>static T_ k_gk(T_ k_hb /*me_*/, type_(Array_<int64_t>) k_hc /*type*/, int64_t k_hd /*start*/, int64_t k_he /*len*/);
static char16_t k_gr();
...
int64_t k_at;
int64_t k_av; // ans
type_(Array_<int64_t>) k_aw; // diff
int64_t k_ba;
int64_t k_bf;
int64_t k_bh; // l
int64_t k_bi; // r
...
(k_av) = (0LL);
(k_aw) = (newArrays_<type_(Array_<int64_t>)>(((k_am) - (1LL))));
for(k_ba = (0LL), k_bb = ((k_am) - (2LL)); k_ba <= k_bb; k_ba += (1LL)){
((k_aw)->At(k_ba)) = (((k_ap)->At((k_ba) + (1LL))) - ((k_ap)->At(k_ba)));
(k_av) = ((k_av) + ((k_bd)(((k_aw)->At(k_ba)))));
}
for(k_bf = (1LL), k_bg = (k_ao); k_bf <= k_bg; k_bf += (1LL)){
(k_bh) = (((k_an)()) - (1LL));
(k_bi) = (((k_an)()) - (1LL));
(k_bj) = ((k_an)());
if((k_bh) != (0LL)){
(k_av) = ((k_av) - ((k_bd)(((k_aw)->At((k_bh) - (1LL))))));
(k_bo) = ((k_bh) - (1LL));
((k_aw)->At(k_bo)) = (((k_aw)->At(k_bo)) + (k_bj));
(k_av) = ((k_av) + ((k_bd)(((k_aw)->At((k_bh) - (1LL))))));
}
if((k_bi) != ((k_am) - (1LL))){
(k_av) = ((k_av) - ((k_bd)(((k_aw)->At(k_bi)))));
((k_aw)->At(k_bi)) = (((k_aw)->At(k_bi)) - (k_bj));
(k_av) = ((k_av) + ((k_bd)(((k_aw)->At(k_bi)))));
}
(k_bv)((((newArrayBin_<char16_t>(0,""))->Cat(k_bw<int64_t>((k_av), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
}
// _finVars
static void k_i(){
...
// inputStr
static type_(Array_<char16_t>) k_eu(){
type_(Array_<char16_t>) k_fr; // buf
int64_t k_fs; // ptr
char16_t k_fw; // c
(k_fr) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fs) = (0LL);
while(true){
(k_fw) = ((k_fx)());
if((k_fw) == (u'\uFFFF')){
...
if((k_fs) == ((k_fr)->Len())){
(k_fr) = ((k_fr)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fr)->Len()))));
}
((k_fr)->At(k_fs)) = (k_fw);
(k_fs) = ((k_fs) + (1LL));
}
return k_gk<type_(Array_<char16_t>)>((k_fr), (nullptr), (0LL), (k_fs));
}
// _toInt
static int64_t k_ex(type_(Array_<char16_t>) k_gl /*me_*/, bool* k_gm /*success*/){
std::u16string u_=k_gl->B;
...
while(true){
(k_gq) = ((k_gr)());
for(k_gv = (0LL), k_gw = (((k_al)->Len()) - (1LL)); k_gv <= k_gw; k_gv += (1LL)){
if(((k_gq) == ((k_al)->At(k_gv))) || (((k_gq) == (u'\u000D')) && (((k_al)->At(k_gv)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_gq) == (u'\u000D')){
