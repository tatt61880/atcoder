...
static int64_t k_ak();
static int64_t k_an();
static void k_aq(type_(Array_<char16_t>) k_dv /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_ar(T_ k_dw /*me_*/, type_(Array_<int64_t>) k_dx /*type*/);
...
template<typename T_>static T_ k_cq(T_ k_eg /*me_*/, type_(Array_<int64_t>) k_eh /*type*/, int64_t k_ei /*n*/);
static type_(Array_<char16_t>) k_dp();
static int64_t k_ds(type_(Array_<char16_t>) k_ff /*me_*/, bool* k_fg /*success*/);
...
static void k_e(){
type_(k_n) k_ah;
(k_m) = ((k_ag)((k_ah = new_(k_n)(), k_w(k_ah), k_ah), (k_ai<uint32_t>((static_cast<uint32_t>((k_aj)())), (new_(Array_<int64_t>)((0LL))), (static_cast<uint32_t>((k_ak)()))))));
}
// _initVars
static void k_f(){
...
(k_ao) = ((k_an)());
(k_ap) = ((k_am) - (k_ao));
(k_aq)((((newArrayBin_<char16_t>(0,""))->Cat(k_ar<int64_t>((k_ap), (new_(Array_<int64_t>)((0LL))))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
return k_cd<uint64_t>((k_ce<uint64_t>((static_cast<uint64_t>(k_cb)), (new_(Array_<int64_t>)((0LL))), (32LL))), (new_(Array_<int64_t>)((0LL))), (static_cast<uint64_t>((reinterpret_cast<k_cc>(classTable_[(k_ca)->Y + 12]))((k_ca)))));
}
// rndFloat
static double k_z(type_(k_n) k_cf /*me*/, double k_cg /*min*/, double k_ch /*max*/){
...
((k_ck)->k_cp) = ((0x05491333U) * (k_cq<uint32_t>(((k_ck)->k_co), (new_(Array_<int64_t>)((0LL))), (1LL))));
}
// xs128
static uint32_t k_ab(type_(k_n) k_cr /*me*/){
uint32_t k_cs; // t
(k_cs) = (k_ai<uint32_t>(((k_cr)->k_cm), (new_(Array_<int64_t>)((0LL))), (k_ce<uint32_t>(((k_cr)->k_cm), (new_(Array_<int64_t>)((0LL))), (11LL)))));
((k_cr)->k_cm) = ((k_cr)->k_cn);
((k_cr)->k_cn) = ((k_cr)->k_co);
((k_cr)->k_co) = ((k_cr)->k_cp);
((k_cr)->k_cp) = (k_ai<uint32_t>((k_ai<uint32_t>(((k_cr)->k_cp), (new_(Array_<int64_t>)((0LL))), (k_cq<uint32_t>(((k_cr)->k_cp), (new_(Array_<int64_t>)((0LL))), (19LL))))), (new_(Array_<int64_t>)((0LL))), (k_ai<uint32_t>((k_cs), (new_(Array_<int64_t>)((0LL))), (k_cq<uint32_t>((k_cs), (new_(Array_<int64_t>)((0LL))), (8LL)))))));
return (k_cr)->k_cp;
}
// _dtor
static void k_ac(k_n* k_ct){
...
return k_fe<type_(Array_<char16_t>)>((k_el), (new_(Array_<int64_t>)((0LL))), (0LL), (k_em));
}
// _toInt
static int64_t k_ds(type_(Array_<char16_t>) k_ff /*me_*/, bool* k_fg /*success*/){
...
#if 0
func main()
	var h1: int :: cui@inputInt()
	var h2: int :: cui@inputInt()
	var ans: int :: h1 - h2
	do cui@print("\{ans}\n")
end func
#endif