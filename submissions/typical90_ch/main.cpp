...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static T_ k_bl(T_ k_fm /*me_*/, type_(Array_<int64_t>) k_fn /*type*/, T_ k_fo /*n*/);
static void k_ch(type_(Array_<char16_t>) k_fp /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_ci(T_ k_fq /*me_*/, type_(Array_<int64_t>) k_fr /*type*/);
template<typename T_>static T_ k_du(T_ k_fs /*me_*/, type_(Array_<int64_t>) k_ft /*type*/, T_ k_fu /*n*/);
template<typename T_>static T_ k_dv(T_ k_fv /*me_*/, type_(Array_<int64_t>) k_fw /*type*/, int64_t k_fx /*n*/);
template<typename T_>static T_ k_eh(T_ k_ga /*me_*/, type_(Array_<int64_t>) k_gb /*type*/, int64_t k_gc /*n*/);
static type_(Array_<char16_t>) k_fg();
static int64_t k_fj(type_(Array_<char16_t>) k_gz /*me_*/, bool* k_ha /*success*/);
static char16_t k_gl();
template<typename T_>static T_ k_gy(T_ k_hp /*me_*/, type_(Array_<int64_t>) k_hq /*type*/, int64_t k_hr /*start*/, int64_t k_hs /*len*/);
static char16_t k_hf();
...
type_(Array_<int64_t>) k_ar; // z
type_(Array_<int64_t>) k_as; // w
int64_t k_aw;
int64_t k_ay; // ans
int64_t k_bc;
int64_t k_be; // cnt
type_(Array_<int64_t>) k_bf; // wi
int64_t k_bj;
int64_t k_bp;
int64_t k_br; // id
type_(Array_<int64_t>) k_bs; // a
int64_t k_bt; // j
int64_t k_ca;
int64_t k_ax;
int64_t k_bd;
...
(k_as) = (newArrays_<type_(Array_<int64_t>)>((k_ao)));
for(k_aw = (0LL), k_ax = ((k_ao) - (1LL)); k_aw <= k_ax; k_aw += (1LL)){
((k_ap)->At(k_aw)) = (((k_an)()) - (1LL));
((k_aq)->At(k_aw)) = (((k_an)()) - (1LL));
((k_ar)->At(k_aw)) = (((k_an)()) - (1LL));
((k_as)->At(k_aw)) = ((k_an)());
}
(k_ay) = (1LL);
for(k_bc = (0LL), k_bd = (59LL); k_bc <= k_bd; k_bc += (1LL)){
(k_be) = (0LL);
(k_bf) = (newArrays_<type_(Array_<int64_t>)>((k_ao)));
for(k_bj = (0LL), k_bk = ((k_ao) - (1LL)); k_bj <= k_bk; k_bj += (1LL)){
((k_bf)->At(k_bj)) = (((k_bl<uint64_t>((static_cast<uint64_t>((k_as)->At(k_bj))), (nullptr), (static_cast<uint64_t>(powI_((2LL), (k_bc)))))) != (0x0000000000000000ULL)) ? (1LL) : (0LL));
}
for(k_bp = (0LL), k_bq = ((powI_((2LL), (k_am))) - (1LL)); k_bp <= k_bq; k_bp += (1LL)){
(k_br) = (k_bp);
(k_bs) = (newArrays_<type_(Array_<int64_t>)>((k_am)));
(k_bt) = (0LL);
while((k_br) != (0LL)){
((k_bs)->At(k_bt)) = ((k_br) % (2LL));
(k_bt) = ((k_bt) + (1LL));
(k_br) = ((k_br) / (2LL));
}
for(k_ca = (0LL), k_cb = ((k_ao) - (1LL)); k_ca <= k_cb; k_ca += (1LL)){
if(((((((k_bs)->At((k_ap)->At(k_ca))) + ((k_bs)->At((k_aq)->At(k_ca)))) + ((k_bs)->At((k_ar)->At(k_ca)))) != (0LL)) ? (1LL) : (0LL)) != ((k_bf)->At(k_ca))){
goto k_bo;
}
}
(k_be) = ((k_be) + (1LL));
...
(k_ay) = ((k_ay) * (k_be));
(k_ay) = ((k_ay) % (1000000007LL));
}
(k_ch)((((newArrayBin_<char16_t>(0,""))->Cat(k_ci<int64_t>((k_ay), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_fp->B),stdout);
#else
...
// inputStr
static type_(Array_<char16_t>) k_fg(){
type_(Array_<char16_t>) k_gf; // buf
int64_t k_gg; // ptr
char16_t k_gk; // c
(k_gf) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_gg) = (0LL);
while(true){
(k_gk) = ((k_gl)());
if((k_gk) == (u'\uFFFF')){
...
if((k_gg) == ((k_gf)->Len())){
(k_gf) = ((k_gf)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_gf)->Len()))));
}
((k_gf)->At(k_gg)) = (k_gk);
(k_gg) = ((k_gg) + (1LL));
}
return k_gy<type_(Array_<char16_t>)>((k_gf), (nullptr), (0LL), (k_gg));
}
// _toInt
static int64_t k_fj(type_(Array_<char16_t>) k_gz /*me_*/, bool* k_ha /*success*/){
std::u16string u_=k_gz->B;
...
while(true){
(k_he) = ((k_hf)());
for(k_hj = (0LL), k_hk = (((k_al)->Len()) - (1LL)); k_hj <= k_hk; k_hj += (1LL)){
if(((k_he) == ((k_al)->At(k_hj))) || (((k_he) == (u'\u000D')) && (((k_al)->At(k_hj)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_he) == (u'\u000D')){
