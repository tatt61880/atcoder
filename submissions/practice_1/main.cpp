...
using k_bz=uint64_t(*)(type_(k_n));
static uint64_t k_y(type_(k_n) k_cc /*me*/);
using k_ce=uint32_t(*)(type_(k_n));
static double k_z(type_(k_n) k_ch /*me*/, double k_ci /*min*/, double k_cj /*max*/);
...
static void k_as(type_(Array_<char16_t>) k_er /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_at(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/);
template<typename T_>static T_ k_cf(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/, T_ k_ew /*n*/);
template<typename T_>static T_ k_cg(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
template<typename T_>static T_ k_cs(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/);
static type_(Array_<char16_t>) k_dr();
static int64_t k_du(type_(Array_<char16_t>) k_ga /*me_*/, bool* k_gb /*success*/);
static char16_t k_ed();
template<typename T_>static T_ k_eq(T_ k_gc /*me_*/, type_(Array_<int64_t>) k_gd /*type*/, int64_t k_ge /*start*/, int64_t k_gf /*len*/);
...
uint64_t k_bv; // m
uint64_t k_bw; // r
(k_bu) = (static_cast<uint64_t>(((k_br) - (k_bq)) + (1LL)));
(k_bv) = ((0x0000000000000000ULL) - (((0x0000000000000000ULL) - (k_bu)) % (k_bu)));
(k_bw) = (0x0000000000000000ULL);
if((k_bv) == (0x0000000000000000ULL)){
(k_bw) = ((reinterpret_cast<k_bz>(classTable_[(k_bp)->Y + 9]))((k_bp)));
}
else{
do{
(k_bw) = ((reinterpret_cast<k_bz>(classTable_[(k_bp)->Y + 9]))((k_bp)));
...
return (static_cast<int64_t>((k_bw) % (k_bu))) + (k_bq);
}
// rndBit64
static uint64_t k_y(type_(k_n) k_cc /*me*/){
uint32_t k_cd; // t
(k_cd) = ((reinterpret_cast<k_ce>(classTable_[(k_cc)->Y + 12]))((k_cc)));
return k_cf<uint64_t>((k_cg<uint64_t>((static_cast<uint64_t>(k_cd)), (nullptr), (32LL))), (nullptr), (static_cast<uint64_t>((reinterpret_cast<k_ce>(classTable_[(k_cc)->Y + 12]))((k_cc)))));
}
// rndFloat
static double k_z(type_(k_n) k_ch /*me*/, double k_ci /*min*/, double k_cj /*max*/){
return (((static_cast<double>((reinterpret_cast<k_bz>(classTable_[(k_ch)->Y + 9]))((k_ch)))) / (1.844674407370955e+19)) * ((k_cj) - (k_ci))) + (k_ci);
}
// setSeed
static void k_aa(type_(k_n) k_cm /*me*/, uint32_t k_cn /*seed*/){
...
static uint32_t k_ab(type_(k_n) k_ct /*me*/){
uint32_t k_cu; // t
(k_cu) = (k_ai<uint32_t>(((k_ct)->k_co), (nullptr), (k_cg<uint32_t>(((k_ct)->k_co), (nullptr), (11LL)))));
((k_ct)->k_co) = ((k_ct)->k_cp);
((k_ct)->k_cp) = ((k_ct)->k_cq);
((k_ct)->k_cq) = ((k_ct)->k_cr);
...
return k_eq<type_(Array_<char16_t>)>((k_fh), (nullptr), (0LL), (k_fi));
}
// _toInt
static int64_t k_du(type_(Array_<char16_t>) k_ga /*me_*/, bool* k_gb /*success*/){
