...
static int64_t k_ak();
static int64_t k_an();
static void k_aq(type_(Array_<char16_t>) k_ex /*str*/);
template<typename T_>static T_ k_df(T_ k_ey /*me_*/, type_(Array_<int64_t>) k_ez /*type*/, T_ k_fa /*n*/);
template<typename T_>static T_ k_dg(T_ k_fb /*me_*/, type_(Array_<int64_t>) k_fc /*type*/, int64_t k_fd /*n*/);
template<typename T_>static T_ k_ds(T_ k_fg /*me_*/, type_(Array_<int64_t>) k_fh /*type*/, int64_t k_fi /*n*/);
static type_(Array_<char16_t>) k_er();
static int64_t k_eu(type_(Array_<char16_t>) k_gf /*me_*/, bool* k_gg /*success*/);
...
int64_t k_au;
int64_t k_aw; // id
int64_t k_ax; // cntOpen
int64_t k_ay; // cntClose
type_(Array_<bool>) k_az; // a
int64_t k_bd;
int64_t k_bs;
int64_t k_av;
int64_t k_be;
...
(k_am) = ((k_an)());
if(((k_am) % (2LL)) != (0LL)){
(k_aq)((newArrayBin_<char16_t>(1,"\x0A\x00")));
return;
}
for(k_au = (0LL), k_av = ((powI_((2LL), (k_am))) - (1LL)); k_au <= k_av; k_au += (1LL)){
(k_aw) = (k_au);
(k_ax) = (0LL);
(k_ay) = (0LL);
(k_az) = (newArrays_<type_(Array_<bool>)>((k_am)));
for(k_bd = (0LL), k_be = ((k_am) - (1LL)); k_bd <= k_be; k_bd += (1LL)){
((k_az)->At(k_bd)) = (((k_aw) % (2LL)) == (1LL));
if((k_az)->At(k_bd)){
(k_ax) = ((k_ax) + (1LL));
if((k_ax) > ((k_am) / (2LL))){
goto k_at;
...
for(k_bs = ((k_am) - (1LL)), k_bt = (0LL); k_bs >= k_bt; k_bs += (-1LL)){
(k_aq)((((k_az)->At(k_bs)) ? (newArrayBin_<char16_t>(1,"\x29\x00")) : (newArrayBin_<char16_t>(1,"\x28\x00"))));
}
(k_aq)((newArrayBin_<char16_t>(1,"\x0A\x00")));
k_at:;
}
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_ex->B),stdout);
#else
std::u16string s_=k_ex->B;
...
if((k_fm) == ((k_fl)->Len())){
(k_fl) = ((k_fl)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_fl)->Len()))));
}
((k_fl)->At(k_fm)) = (k_fq);
(k_fm) = ((k_fm) + (1LL));
}
