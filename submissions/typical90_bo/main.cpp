...
static int64_t k_ap();
static int64_t k_bb(int64_t k_fg /*x*/);
static char16_t k_bf(char16_t k_ft /*me_*/, int64_t k_fu /*n*/);
template<typename T_>static void k_bh(T_ k_fv /*me_*/, type_(Array_<int64_t>) k_fw /*type*/);
static void k_bi(type_(Array_<char16_t>) k_fx /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bj(T_ k_fy /*me_*/, type_(Array_<int64_t>) k_fz /*type*/);
template<typename T_>static T_ k_cv(T_ k_ga /*me_*/, type_(Array_<int64_t>) k_gb /*type*/, T_ k_gc /*n*/);
template<typename T_>static T_ k_cw(T_ k_gd /*me_*/, type_(Array_<int64_t>) k_ge /*type*/, int64_t k_gf /*n*/);
template<typename T_>static T_ k_di(T_ k_gi /*me_*/, type_(Array_<int64_t>) k_gj /*type*/, int64_t k_gk /*n*/);
static char16_t k_em();
template<typename T_>static T_ k_ez(T_ k_hb /*me_*/, type_(Array_<int64_t>) k_hc /*type*/, int64_t k_hd /*start*/, int64_t k_he /*len*/);
static int64_t k_fd(type_(Array_<char16_t>) k_hf /*me_*/, bool* k_hg /*success*/);
...
// main
static void k_g(){
type_(Array_<char16_t>) k_am; // n
int64_t k_ao; // k
int64_t k_aq; // x
int64_t k_au;
int64_t k_az;
type_(Array_<char16_t>) k_bc; // ans
int64_t k_av;
int64_t k_ba;
(k_am) = ((k_an)());
(k_ao) = ((k_ap)());
...
(k_aq) = ((k_aq) * (8LL));
(k_aq) = ((k_aq) + ((static_cast<int64_t>((k_am)->At(k_au))) - (48LL)));
}
for(k_az = (1LL), k_ba = (k_ao); k_az <= k_ba; k_az += (1LL)){
(k_aq) = ((k_bb)((k_aq)));
}
(k_bc) = (newArrays_<type_(Array_<char16_t>)>((0LL)));
do{
(k_bc) = ((k_bc)->Cat(new_(Array_<char16_t>)(((k_bf)((u'\u0030'), ((k_aq) % (8LL)))))));
(k_aq) = ((k_aq) / (8LL));
}while((k_aq) != (0LL));
k_bh<type_(Array_<char16_t>)>((k_bc), (nullptr));
(k_bi)((((newArrayBin_<char16_t>(0,""))->Cat(k_bj<type_(Array_<char16_t>)>((k_bc), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
// inputStr
static type_(Array_<char16_t>) k_an(){
type_(Array_<char16_t>) k_eg; // buf
int64_t k_eh; // ptr
char16_t k_el; // c
(k_eg) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_eh) = (0LL);
while(true){
(k_el) = ((k_em)());
if((k_el) == (u'\uFFFF')){
...
if((k_eh) == ((k_eg)->Len())){
(k_eg) = ((k_eg)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_eg)->Len()))));
}
((k_eg)->At(k_eh)) = (k_el);
(k_eh) = ((k_eh) + (1LL));
}
return k_ez<type_(Array_<char16_t>)>((k_eg), (nullptr), (0LL), (k_eh));
}
// inputInt
static int64_t k_ap(){
type_(Array_<char16_t>) k_fa; // s
bool k_fb; // b
int64_t k_fc; // r
(k_fa) = ((k_an)());
(k_fb) = (false);
...
switch(k_fm){
case 8LL:
(k_fh) = ((k_fh) + ((5LL) * (powI_((8LL), (k_fi)))));
break;
default:
(k_fh) = ((k_fh) + ((k_fm) * (powI_((8LL), (k_fi)))));
break;
}
(k_fi) = ((k_fi) + (1LL));
(k_fg) = ((k_fg) / (9LL));
...
// _offset
static char16_t k_bf(char16_t k_ft /*me_*/, int64_t k_fu /*n*/){
return static_cast<char16_t>((static_cast<uint64_t>(k_ft)) + (static_cast<uint64_t>(k_fu)));
}
// _reverse
template<typename T_>static void k_bh(T_ k_fv /*me_*/, type_(Array_<int64_t>) k_fw /*type*/){
reverse_(k_fv);
