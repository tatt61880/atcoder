...
static void k_i();
static void k_j();
static void k_l(int64_t k_cp /*excpt*/);
static void k_p(type_(k_o) k_cs /*me*/);
static void k_q(k_o* k_ct);
static int64_t k_r(type_(k_o) k_cu /*me*/, type_(k_o) k_cv /*t*/);
static type_(k_o) k_s(type_(k_o) k_cw /*me*/);
static type_(Array_<uint8_t>) k_t(type_(k_o) k_cz /*me*/);
static type_(k_o) k_u(type_(k_o) k_db /*me*/, type_(Array_<uint8_t>) k_dc /*bin*/, int64_t* k_dd /*idx*/);
static type_(Array_<char16_t>) k_v(type_(k_o) k_dg /*me*/);
static void k_w(type_(k_n) k_dh /*me*/);
using k_dj=void(*)(type_(k_o));
static int64_t k_x(type_(k_n) k_dk /*me*/, int64_t k_dl /*min*/, int64_t k_dm /*max*/);
using k_du=uint64_t(*)(type_(k_n));
static uint64_t k_y(type_(k_n) k_dx /*me*/);
using k_dz=uint32_t(*)(type_(k_n));
static double k_z(type_(k_n) k_ec /*me*/, double k_ed /*min*/, double k_ee /*max*/);
static void k_aa(type_(k_n) k_eh /*me*/, uint32_t k_ei /*seed*/);
static uint32_t k_ab(type_(k_n) k_eo /*me*/);
static void k_ac(k_n* k_eq);
static type_(k_n) k_ad(type_(k_n) k_er);
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_eu);
static type_(k_n) k_af(type_(k_n) k_fa, type_(Array_<uint8_t>) k_fb, int64_t* k_fc);
static type_(k_n) k_ag(type_(k_n) k_ff /*me2*/, uint32_t k_fg /*seed*/);
using k_fh=void(*)(type_(k_n), uint32_t);
template<typename T_>static T_ k_ai(T_ k_fi /*me_*/, type_(Array_<int64_t>) k_fj /*type*/, T_ k_fk /*n*/);
static int64_t k_aj();
static int64_t k_ak();
static int64_t k_an();
static void k_cb(type_(Array_<char16_t>) k_fs /*str*/);
static int64_t k_cf(int64_t k_ft /*me_*/);
template<typename T_>static type_(Array_<char16_t>) k_co(T_ k_fu /*me_*/, type_(Array_<int64_t>) k_fv /*type*/);
template<typename T_>static T_ k_ea(T_ k_fw /*me_*/, type_(Array_<int64_t>) k_fx /*type*/, T_ k_fy /*n*/);
template<typename T_>static T_ k_eb(T_ k_fz /*me_*/, type_(Array_<int64_t>) k_ga /*type*/, int64_t k_gb /*n*/);
template<typename T_>static T_ k_en(T_ k_ge /*me_*/, type_(Array_<int64_t>) k_gf /*type*/, int64_t k_gg /*n*/);
static type_(Array_<char16_t>) k_fm();
static int64_t k_fp(type_(Array_<char16_t>) k_hd /*me_*/, bool* k_he /*success*/);
static char16_t k_gp();
template<typename T_>static T_ k_hc(T_ k_ht /*me_*/, type_(Array_<int64_t>) k_hu /*type*/, int64_t k_hv /*start*/, int64_t k_hw /*len*/);
static char16_t k_hj();
...
k_n::k_n(): k_o(), k_ej(), k_ek(), k_el(), k_em(){ Y = 8; }
k_n::~k_n(){
k_ac(this);
}
// k_main_
...
int64_t k_am; // h
int64_t k_ao; // w
type_(Array_<type_(Array_<int64_t>)>) k_ap; // a
int64_t k_at;
int64_t k_ay;
int64_t k_bd;
int64_t k_bi;
type_(Array_<int64_t>) k_bl;
int64_t k_bm; // ans
int64_t k_bq;
int64_t k_bv;
int64_t k_cd; // v
type_(Array_<int64_t>) k_ch;
int64_t k_ci;
type_(Array_<int64_t>) k_ck;
type_(Array_<int64_t>) k_cm;
int64_t k_cn;
int64_t k_au;
int64_t k_az;
int64_t k_be;
...
for(k_bd = (0LL), k_be = ((k_am) - (1LL)); k_bd <= k_be; k_bd += (1LL)){
for(k_bi = (0LL), k_bj = ((k_ao) - (1LL)); k_bi <= k_bj; k_bi += (1LL)){
(k_bl) = ((k_ap)->At(k_bd));
((k_bl)->At(k_bi)) = (((k_bl)->At(k_bi)) - ((k_an)()));
}
}
(k_bm) = (0LL);
for(k_bq = (0LL), k_br = ((k_am) - (1LL)); k_bq <= k_br; k_bq += (1LL)){
for(k_bv = (0LL), k_bw = ((k_ao) - (1LL)); k_bv <= k_bw; k_bv += (1LL)){
if(((k_bv) == ((k_ao) - (1LL))) || ((k_bq) == ((k_am) - (1LL)))){
if((((k_ap)->At(k_bq))->At(k_bv)) != (0LL)){
(k_cb)((newArrayBin_<char16_t>(3,"\x4E\x00\x6F\x00\x0A\x00")));
return;
}
}
else{
(k_cd) = (((k_ap)->At(k_bq))->At(k_bv));
(k_bm) = ((k_bm) + ((k_cf)((k_cd))));
(k_ch) = ((k_ap)->At(k_bq));
(k_ci) = ((k_bv) + (1LL));
((k_ch)->At(k_ci)) = (((k_ch)->At(k_ci)) - (k_cd));
(k_ck) = ((k_ap)->At((k_bq) + (1LL)));
((k_ck)->At(k_bv)) = (((k_ck)->At(k_bv)) - (k_cd));
(k_cm) = ((k_ap)->At((k_bq) + (1LL)));
(k_cn) = ((k_bv) + (1LL));
((k_cm)->At(k_cn)) = (((k_cm)->At(k_cn)) - (k_cd));
}
}
}
(k_cb)((newArrayBin_<char16_t>(4,"\x59\x00\x65\x00\x73\x00\x0A\x00")));
(k_cb)((((newArrayBin_<char16_t>(0,""))->Cat(k_co<int64_t>((k_bm), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
type_(k_o) k_cx;
type_(k_o) k_cy;
(k_cx) = (k_cy = new_(k_o)(), k_p(k_cy), k_cy);
return as_<k_o>(classTable_, (k_cx), 0);
}
// _toBin
static type_(Array_<uint8_t>) k_t(type_(k_o) k_cz /*me*/){
...
uint64_t k_dq; // m
uint64_t k_dr; // r
(k_dp) = (static_cast<uint64_t>(((k_dm) - (k_dl)) + (1LL)));
(k_dq) = ((0x0000000000000000ULL) - (((0x0000000000000000ULL) - (k_dp)) % (k_dp)));
(k_dr) = (0x0000000000000000ULL);
if((k_dq) == (0x0000000000000000ULL)){
(k_dr) = ((reinterpret_cast<k_du>(classTable_[(k_dk)->Y + 9]))((k_dk)));
}
else{
do{
(k_dr) = ((reinterpret_cast<k_du>(classTable_[(k_dk)->Y + 9]))((k_dk)));
...
return (static_cast<int64_t>((k_dr) % (k_dp))) + (k_dl);
}
// rndBit64
static uint64_t k_y(type_(k_n) k_dx /*me*/){
uint32_t k_dy; // t
(k_dy) = ((reinterpret_cast<k_dz>(classTable_[(k_dx)->Y + 12]))((k_dx)));
return k_ea<uint64_t>((k_eb<uint64_t>((static_cast<uint64_t>(k_dy)), (nullptr), (32LL))), (nullptr), (static_cast<uint64_t>((reinterpret_cast<k_dz>(classTable_[(k_dx)->Y + 12]))((k_dx)))));
}
// rndFloat
static double k_z(type_(k_n) k_ec /*me*/, double k_ed /*min*/, double k_ee /*max*/){
return (((static_cast<double>((reinterpret_cast<k_du>(classTable_[(k_ec)->Y + 9]))((k_ec)))) / (1.844674407370955e+19)) * ((k_ee) - (k_ed))) + (k_ed);
}
// setSeed
static void k_aa(type_(k_n) k_eh /*me*/, uint32_t k_ei /*seed*/){
((k_eh)->k_ej) = (0x075BCD15U);
((k_eh)->k_ek) = (0x159A55E5U);
((k_eh)->k_el) = ((0x1F123BB5U) * (k_ei));
((k_eh)->k_em) = ((0x05491333U) * (k_en<uint32_t>(((k_eh)->k_el), (nullptr), (1LL))));
}
// xs128
static uint32_t k_ab(type_(k_n) k_eo /*me*/){
uint32_t k_ep; // t
(k_ep) = (k_ai<uint32_t>(((k_eo)->k_ej), (nullptr), (k_eb<uint32_t>(((k_eo)->k_ej), (nullptr), (11LL)))));
((k_eo)->k_ej) = ((k_eo)->k_ek);
((k_eo)->k_ek) = ((k_eo)->k_el);
((k_eo)->k_el) = ((k_eo)->k_em);
((k_eo)->k_em) = (k_ai<uint32_t>((k_ai<uint32_t>(((k_eo)->k_em), (nullptr), (k_en<uint32_t>(((k_eo)->k_em), (nullptr), (19LL))))), (nullptr), (k_ai<uint32_t>((k_ep), (nullptr), (k_en<uint32_t>((k_ep), (nullptr), (8LL)))))));
return (k_eo)->k_em;
}
// _dtor
static void k_ac(k_n* k_eq){
...
type_(k_n) k_es;
type_(k_n) k_et;
(k_es) = (k_et = new_(k_n)(), k_w(k_et), k_et);
((k_es)->k_ej) = ((k_er)->k_ej);
((k_es)->k_ek) = ((k_er)->k_ek);
((k_es)->k_el) = ((k_er)->k_el);
((k_es)->k_em) = ((k_er)->k_em);
return as_<k_n>(classTable_, (k_es), 8);
}
// _toBin
static type_(Array_<uint8_t>) k_ae(type_(k_n) k_eu){
type_(Array_<uint8_t>) k_ev;
(k_ev) = (newArrays_<type_(Array_<uint8_t>)>((0LL)));
(k_ev) = ((k_ev)->Cat(toBin_<uint32_t>()(((k_eu)->k_ej))));
(k_ev) = ((k_ev)->Cat(toBin_<uint32_t>()(((k_eu)->k_ek))));
(k_ev) = ((k_ev)->Cat(toBin_<uint32_t>()(((k_eu)->k_el))));
(k_ev) = ((k_ev)->Cat(toBin_<uint32_t>()(((k_eu)->k_em))));
return k_ev;
}
// _fromBin
static type_(k_n) k_af(type_(k_n) k_fa, type_(Array_<uint8_t>) k_fb, int64_t* k_fc){
type_(k_n) k_fd;
type_(k_n) k_fe;
(k_fd) = (k_fe = new_(k_n)(), k_w(k_fe), k_fe);
((k_fd)->k_ej) = (fromBin_<uint32_t>()((k_fb), (*k_fc)));
((k_fd)->k_ek) = (fromBin_<uint32_t>()((k_fb), (*k_fc)));
((k_fd)->k_el) = (fromBin_<uint32_t>()((k_fb), (*k_fc)));
((k_fd)->k_em) = (fromBin_<uint32_t>()((k_fb), (*k_fc)));
return k_fd;
}
// makeRnd
static type_(k_n) k_ag(type_(k_n) k_ff /*me2*/, uint32_t k_fg /*seed*/){
(reinterpret_cast<k_fh>(classTable_[(k_ff)->Y + 11]))((k_ff), (k_fg));
return k_ff;
}
// _xor
template<typename T_>static T_ k_ai(T_ k_fi /*me_*/, type_(Array_<int64_t>) k_fj /*type*/, T_ k_fk /*n*/){
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_fs->B),stdout);
#else
std::u16string s_=k_fs->B;
...
// inputStr
static type_(Array_<char16_t>) k_fm(){
type_(Array_<char16_t>) k_gj; // buf
int64_t k_gk; // ptr
char16_t k_go; // c
(k_gj) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_gk) = (0LL);
while(true){
(k_go) = ((k_gp)());
if((k_go) == (u'\uFFFF')){
...
if((k_gk) == ((k_gj)->Len())){
(k_gj) = ((k_gj)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_gj)->Len()))));
}
((k_gj)->At(k_gk)) = (k_go);
(k_gk) = ((k_gk) + (1LL));
}
return k_hc<type_(Array_<char16_t>)>((k_gj), (nullptr), (0LL), (k_gk));
}
// _toInt
static int64_t k_fp(type_(Array_<char16_t>) k_hd /*me_*/, bool* k_he /*success*/){
std::u16string u_=k_hd->B;
...
while(true){
(k_hi) = ((k_hj)());
for(k_hn = (0LL), k_ho = (((k_al)->Len()) - (1LL)); k_hn <= k_ho; k_hn += (1LL)){
if(((k_hi) == ((k_al)->At(k_hn))) || (((k_hi) == (u'\u000D')) && (((k_al)->At(k_hn)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_hi) == (u'\u000D')){
