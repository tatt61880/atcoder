...
static int64_t k_bd(int64_t k_et /*me_*/);
template<typename T_,typename R_>static R_ k_bl(T_ k_eu /*me_*/, type_(Array_<int64_t>) k_ev /*type*/);
static void k_bm(type_(Array_<char16_t>) k_ew /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bn(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/);
template<typename T_>static T_ k_cz(T_ k_ez /*me_*/, type_(Array_<int64_t>) k_fa /*type*/, T_ k_fb /*n*/);
template<typename T_>static T_ k_da(T_ k_fc /*me_*/, type_(Array_<int64_t>) k_fd /*type*/, int64_t k_fe /*n*/);
template<typename T_>static T_ k_dm(T_ k_fh /*me_*/, type_(Array_<int64_t>) k_fi /*type*/, int64_t k_fj /*n*/);
static type_(Array_<char16_t>) k_el();
static int64_t k_eo(type_(Array_<char16_t>) k_gg /*me_*/, bool* k_gh /*success*/);
...
(k_av) = ((k_an)());
for(k_ax = (1LL), k_ay = (k_av); k_ax <= k_ay; k_ax += (1LL)){
(k_az) = ((k_an)());
(k_ba) = (0LL);
(k_bb) = (k_am);
while(((k_bd)(((k_ba) - (k_bb)))) > (1LL)){
(k_be) = (((k_ba) + (k_bb)) / (2LL));
if(((k_ao)->At(k_be)) <= (k_az)){
(k_ba) = (k_be);
}
else{
(k_bb) = (k_be);
...
(k_bi) = ((k_bd)(((k_az) - ((k_ao)->At(k_ba)))));
if((k_ba) != ((k_am) - (1LL))){
(k_bi) = (k_bl<type_(Array_<int64_t>), int64_t>((new_(Array_<int64_t>)((k_bi), (((k_ao)->At((k_ba) + (1LL))) - (k_az)))), (nullptr)));
}
(k_bm)((((newArrayBin_<char16_t>(0,""))->Cat(k_bn<int64_t>((k_bi), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
}
// _finVars
static void k_i(){
