...
static int64_t k_ak();
static int64_t k_an();
static int64_t k_bf(int64_t k_el /*n1*/, int64_t k_em /*n2*/);
static void k_bg(type_(Array_<char16_t>) k_en /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bh(T_ k_eo /*me_*/, type_(Array_<int64_t>) k_ep /*type*/);
template<typename T_>static T_ k_ct(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/, T_ k_es /*n*/);
template<typename T_>static T_ k_cu(T_ k_et /*me_*/, type_(Array_<int64_t>) k_eu /*type*/, int64_t k_ev /*n*/);
template<typename T_>static T_ k_dg(T_ k_ey /*me_*/, type_(Array_<int64_t>) k_ez /*type*/, int64_t k_fa /*n*/);
static type_(Array_<char16_t>) k_ef();
static int64_t k_ei(type_(Array_<char16_t>) k_fx /*me_*/, bool* k_fy /*success*/);
...
(k_aq) = ((k_an)());
(k_ar) = (9999LL);
for(k_av = (0LL), k_aw = (9999LL); k_av <= k_aw; k_av += (1LL)){
for(k_ba = (0LL), k_bb = ((9999LL) - (k_av)); k_ba <= k_bb; k_ba += (1LL)){
(k_bc) = (((k_am) - ((k_ao) * (k_av))) - ((k_ap) * (k_ba)));
if(((k_bc) >= (0LL)) && (((k_bc) % (k_aq)) == (0LL))){
(k_ar) = ((k_bf)((k_ar), (((k_av) + (k_ba)) + ((k_bc) / (k_aq)))));
}
}
}
(k_bg)((((newArrayBin_<char16_t>(0,""))->Cat(k_bh<int64_t>((k_ar), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
