...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static void k_au(T_ k_ei /*me_*/, type_(Array_<int64_t>) k_ej /*type*/);
template<typename T_>static void k_av(T_ k_ek /*me_*/, type_(Array_<int64_t>) k_el /*type*/);
static void k_bd(type_(Array_<char16_t>) k_em /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_be(T_ k_en /*me_*/, type_(Array_<int64_t>) k_eo /*type*/);
template<typename T_>static T_ k_cq(T_ k_ep /*me_*/, type_(Array_<int64_t>) k_eq /*type*/, T_ k_er /*n*/);
template<typename T_>static T_ k_cr(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, int64_t k_eu /*n*/);
template<typename T_>static T_ k_dd(T_ k_ex /*me_*/, type_(Array_<int64_t>) k_ey /*type*/, int64_t k_ez /*n*/);
static type_(Array_<char16_t>) k_ec();
static int64_t k_ef(type_(Array_<char16_t>) k_fw /*me_*/, bool* k_fx /*success*/);
...
(k_aw) = ((k_aw) + (((1LL) - ((2LL) * ((k_ba) % (2LL)))) * ((k_ao)->At(k_ba))));
}
(k_bd)((((newArrayBin_<char16_t>(0,""))->Cat(k_be<int64_t>((k_aw), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
