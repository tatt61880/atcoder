...
static int64_t k_ak();
static int64_t k_an();
template<typename T_>static void k_ax(T_ k_el /*me_*/, type_(Array_<int64_t>) k_em /*type*/);
template<typename T_>static void k_ay(T_ k_en /*me_*/, type_(Array_<int64_t>) k_eo /*type*/);
static void k_bg(type_(Array_<char16_t>) k_ep /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bh(T_ k_eq /*me_*/, type_(Array_<int64_t>) k_er /*type*/);
template<typename T_>static T_ k_ct(T_ k_es /*me_*/, type_(Array_<int64_t>) k_et /*type*/, T_ k_eu /*n*/);
template<typename T_>static T_ k_cu(T_ k_ev /*me_*/, type_(Array_<int64_t>) k_ew /*type*/, int64_t k_ex /*n*/);
template<typename T_>static T_ k_dg(T_ k_fa /*me_*/, type_(Array_<int64_t>) k_fb /*type*/, int64_t k_fc /*n*/);
static type_(Array_<char16_t>) k_ef();
static int64_t k_ei(type_(Array_<char16_t>) k_fz /*me_*/, bool* k_ga /*success*/);
...
(k_am) = ((k_an)());
(k_ao) = ((k_an)());
(k_ap) = (newArrays_<type_(Array_<int64_t>)>(((2LL) * (k_am))));
for(k_at = (0LL), k_au = ((k_am) - (1LL)); k_at <= k_au; k_at += (1LL)){
(k_av) = ((k_an)());
(k_aw) = ((k_an)());
((k_ap)->At((2LL) * (k_at))) = (k_aw);
((k_ap)->At(((2LL) * (k_at)) + (1LL))) = ((k_av) - (k_aw));
}
k_ax<type_(Array_<int64_t>)>((k_ap), (nullptr));
k_ay<type_(Array_<int64_t>)>((k_ap), (nullptr));
(k_az) = (0LL);
for(k_bd = (0LL), k_be = ((k_ao) - (1LL)); k_bd <= k_be; k_bd += (1LL)){
(k_az) = ((k_az) + ((k_ap)->At(k_bd)));
}
(k_bg)((((newArrayBin_<char16_t>(0,""))->Cat(k_bh<int64_t>((k_az), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
