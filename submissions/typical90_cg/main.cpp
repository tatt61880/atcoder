...
static int64_t k_ak();
static int64_t k_an();
static void k_bb(type_(Array_<char16_t>) k_eg /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bc(T_ k_eh /*me_*/, type_(Array_<int64_t>) k_ei /*type*/);
template<typename T_>static T_ k_co(T_ k_ej /*me_*/, type_(Array_<int64_t>) k_ek /*type*/, T_ k_el /*n*/);
template<typename T_>static T_ k_cp(T_ k_em /*me_*/, type_(Array_<int64_t>) k_en /*type*/, int64_t k_eo /*n*/);
template<typename T_>static T_ k_db(T_ k_er /*me_*/, type_(Array_<int64_t>) k_es /*type*/, int64_t k_et /*n*/);
static type_(Array_<char16_t>) k_ea();
static int64_t k_ed(type_(Array_<char16_t>) k_fq /*me_*/, bool* k_fr /*success*/);
static char16_t k_fc();
template<typename T_>static T_ k_fp(T_ k_gg /*me_*/, type_(Array_<int64_t>) k_gh /*type*/, int64_t k_gi /*start*/, int64_t k_gj /*len*/);
...
(k_ao) = (1LL);
(k_ap) = (0LL);
while((((k_ao) * (k_ao)) * (k_ao)) <= (k_am)){
if(((k_am) % (k_ao)) == (0LL)){
(k_at) = ((k_am) / (k_ao));
(k_au) = (k_ao);
while(((k_au) * (k_au)) <= (k_at)){
if(((k_at) % (k_au)) == (0LL)){
(k_ap) = ((k_ap) + (1LL));
}
(k_au) = ((k_au) + (1LL));
...
#if defined(_WIN32)
fputws(reinterpret_cast<const wchar_t*>(k_eg->B),stdout);
#else
std::u16string s_=k_eg->B;
...
// inputStr
static type_(Array_<char16_t>) k_ea(){
type_(Array_<char16_t>) k_ew; // buf
int64_t k_ex; // ptr
char16_t k_fb; // c
(k_ew) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_ex) = (0LL);
while(true){
(k_fb) = ((k_fc)());
if((k_fb) == (u'\uFFFF')){
...
if((k_ex) == ((k_ew)->Len())){
(k_ew) = ((k_ew)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_ew)->Len()))));
}
((k_ew)->At(k_ex)) = (k_fb);
(k_ex) = ((k_ex) + (1LL));
}
return k_fp<type_(Array_<char16_t>)>((k_ew), (nullptr), (0LL), (k_ex));
}
// _toInt
static int64_t k_ed(type_(Array_<char16_t>) k_fq /*me_*/, bool* k_fr /*success*/){
std::u16string u_=k_fq->B;
...
while(true){
(k_fv) = ((k_fw)());
for(k_ga = (0LL), k_gb = (((k_al)->Len()) - (1LL)); k_ga <= k_gb; k_ga += (1LL)){
if(((k_fv) == ((k_al)->At(k_ga))) || (((k_fv) == (u'\u000D')) && (((k_al)->At(k_ga)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_fv) == (u'\u000D')){
