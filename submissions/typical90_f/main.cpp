...
static int64_t k_ak();
static int64_t k_an();
static type_(Array_<char16_t>) k_aq();
template<typename T_>static T_ k_at(T_ k_ft /*me_*/, type_(Array_<int64_t>) k_fu /*type*/, int64_t k_fv /*len*/);
static char16_t k_bt(char16_t k_fy /*me_*/, int64_t k_fz /*n*/);
static void k_bu(type_(Array_<char16_t>) k_ga /*str*/);
template<typename T_>static type_(Array_<char16_t>) k_bv(T_ k_gb /*me_*/, type_(Array_<int64_t>) k_gc /*type*/);
template<typename T_>static T_ k_dh(T_ k_gd /*me_*/, type_(Array_<int64_t>) k_ge /*type*/, T_ k_gf /*n*/);
template<typename T_>static T_ k_di(T_ k_gg /*me_*/, type_(Array_<int64_t>) k_gh /*type*/, int64_t k_gi /*n*/);
template<typename T_>static T_ k_du(T_ k_gl /*me_*/, type_(Array_<int64_t>) k_gm /*type*/, int64_t k_gn /*n*/);
static type_(Array_<char16_t>) k_et();
static int64_t k_ew(type_(Array_<char16_t>) k_hj /*me_*/, bool* k_hk /*success*/);
static char16_t k_ff();
template<typename T_>static T_ k_fs(T_ k_hl /*me_*/, type_(Array_<int64_t>) k_hm /*type*/, int64_t k_hn /*start*/, int64_t k_ho /*len*/);
...
int64_t k_am; // n
int64_t k_ao; // k
type_(Array_<char16_t>) k_ap; // s
type_(Array_<type_(Array_<int64_t>)>) k_ar; // nextPos
type_(Array_<int64_t>) k_as; // pos
int64_t k_ax;
int64_t k_bc;
int64_t k_be; // p
type_(Array_<char16_t>) k_bf; // ans
int64_t k_bj;
int64_t k_bo;
int64_t k_bq; // remains
int64_t k_ay;
int64_t k_bd;
int64_t k_bk;
int64_t k_bp;
...
(k_ao) = ((k_an)());
(k_ap) = ((k_aq)());
(k_ar) = (newArrays_<type_(Array_<type_(Array_<int64_t>)>)>((k_am), (26LL)));
(k_as) = (k_at<type_(Array_<int64_t>)>((new_(Array_<int64_t>)((k_am))), (nullptr), (26LL)));
for(k_ax = ((k_am) - (1LL)), k_ay = (0LL); k_ax >= k_ay; k_ax += (-1LL)){
((k_as)->At((static_cast<int64_t>((k_ap)->At(k_ax))) - (97LL))) = (k_ax);
for(k_bc = (0LL), k_bd = (25LL); k_bc <= k_bd; k_bc += (1LL)){
(((k_ar)->At(k_ax))->At(k_bc)) = ((k_as)->At(k_bc));
}
}
(k_be) = (0LL);
(k_bf) = (newArrays_<type_(Array_<char16_t>)>((k_ao)));
for(k_bj = (0LL), k_bk = ((k_ao) - (1LL)); k_bj <= k_bk; k_bj += (1LL)){
for(k_bo = (0LL), k_bp = (25LL); k_bo <= k_bp; k_bo += (1LL)){
(k_bq) = (((k_am) - (1LL)) - (((k_ar)->At(k_be))->At(k_bo)));
if((k_bq) >= (((k_ao) - (1LL)) - (k_bj))){
((k_bf)->At(k_bj)) = ((k_bt)((u'\u0061'), (k_bo)));
(k_be) = ((((k_ar)->At(k_be))->At(k_bo)) + (1LL));
break;
}
}
}
(k_bu)((((newArrayBin_<char16_t>(0,""))->Cat(k_bv<type_(Array_<char16_t>)>((k_bf), (nullptr))))->Cat(newArrayBin_<char16_t>(1,"\x0A\x00"))));
}
// _finVars
static void k_i(){
(k_al) = (nullptr);
...
// input
static type_(Array_<char16_t>) k_aq(){
type_(Array_<char16_t>) k_ez; // buf
int64_t k_fa; // ptr
char16_t k_fe; // c
(k_ez) = (newArrays_<type_(Array_<char16_t>)>((1024LL)));
(k_fa) = (0LL);
while(true){
(k_fe) = ((k_ff)());
if((k_fe) == (u'\u000D')){
...
if((k_fa) == ((k_ez)->Len())){
(k_ez) = ((k_ez)->Cat(newArrays_<type_(Array_<char16_t>)>(((k_ez)->Len()))));
}
((k_ez)->At(k_fa)) = (k_fe);
(k_fa) = ((k_fa) + (1LL));
}
return k_fs<type_(Array_<char16_t>)>((k_ez), (nullptr), (0LL), (k_fa));
}
// _repeat
template<typename T_>static T_ k_at(T_ k_ft /*me_*/, type_(Array_<int64_t>) k_fu /*type*/, int64_t k_fv /*len*/){
return repeat_(k_ft,k_fv);
}
// _offset
static char16_t k_bt(char16_t k_fy /*me_*/, int64_t k_fz /*n*/){
return static_cast<char16_t>((static_cast<uint64_t>(k_fy)) + (static_cast<uint64_t>(k_fz)));
}
// print
static void k_bu(type_(Array_<char16_t>) k_ga /*str*/){
if(k_ga==nullptr){
...
return k_fs<type_(Array_<char16_t>)>((k_gq), (nullptr), (0LL), (k_gr));
}
// _toInt
static int64_t k_ew(type_(Array_<char16_t>) k_hj /*me_*/, bool* k_hk /*success*/){
...
while(true){
(k_hs) = ((k_ff)());
for(k_hw = (0LL), k_hx = (((k_al)->Len()) - (1LL)); k_hw <= k_hx; k_hw += (1LL)){
if(((k_hs) == ((k_al)->At(k_hw))) || (((k_hs) == (u'\u000D')) && (((k_al)->At(k_hw)) == (u'\u000A')))){
return u'\u0000';
}
}
if((k_hs) == (u'\u000D')){
